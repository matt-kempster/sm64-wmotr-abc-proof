(* ======================================================================
   ...
   From source: vendor/sm64/src/engine/surface_collision.c
   clightgen:   The CompCert CompCert AST generator, version 3.15
   Flags:       -normalize -nostdinc -fstruct-passing -Ivendor/sm64/include -Ivendor/sm64/build/us -Ivendor/sm64/build/us/include -Ivendor/sm64/src -Ivendor/sm64 -Ivendor/sm64/include/libc -DVERSION_US=1 -DF3DEX_GBI_2=1 -DF3DEX_GBI_SHARED=1 -D_FINALROM=1 -DTARGET_N64=1 -DNON_MATCHING=1 -DAVOID_UB=1 -D_LANGUAGE_C=1 (+ __stringlit_ -> __stringlit_surface_collision_)
...
Module Info.
  ...
  Definition source_file := "vendor/sm64/src/engine/surface_collision.c".
...
Definition ___stringlit_1 : ident := $"__stringlit_surface_collision_1".
Definition ___stringlit_2 : ident := $"__stringlit_surface_collision_2".
Definition ___stringlit_3 : ident := $"__stringlit_surface_collision_3".
Definition ___stringlit_4 : ident := $"__stringlit_surface_collision_4".
Definition ___stringlit_5 : ident := $"__stringlit_surface_collision_5".
Definition ___stringlit_6 : ident := $"__stringlit_surface_collision_6".
Definition ___stringlit_7 : ident := $"__stringlit_surface_collision_7".
Definition ___stringlit_8 : ident := $"__stringlit_surface_collision_8".
                                      ...
                                      (Efield
                                        (Efield
                                          (Ederef
                                            (Etempvar _surf (tptr (Tstruct _Surface noattr)))
                                            (Tstruct _Surface noattr))
                                          _normal (Tstruct __769 noattr)) _y
                                        tfloat))
                                    (Ssequence
                                      (Sset _nz
                                        (Efield
                                      ...
                                      (Efield
                                        (Efield
                                          (Ederef
                                            (Etempvar _surf (tptr (Tstruct _Surface noattr)))
                                            (Tstruct _Surface noattr))
                                          _normal (Tstruct __769 noattr)) _z
                                        tfloat))
                                    (Ssequence
                                      (Sset _oo
                                        (Efield
