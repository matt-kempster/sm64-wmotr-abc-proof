(* ====================================================================== *)
(* LandingBricks.v  --  the LANDING KEYSTONE (PROMOTED, spine).             *)
(* clc_funcall_pres_marg is consumed by MovingLeafSurface.clc_site_pres,    *)
(* discharging the 3 clean common_landing_cancels leaves (jump/freefall/    *)
(* double_jump) on the no-A no-fly capstone.  HMWF_ktab / HMWF_inp are      *)
(* supplied at the capstone via MWFReal.mwf_real_ktab / mwf_real_inp.       *)
(*                                                                        *)
