(* GENERATED FILE -- DO NOT EDIT.
   Source: ../../../reference-sm64-decomp/lib/src/__osSiRawStartDma.c
   clightgen: The CompCert CompCert AST generator, version 3.15
   Flags: -normalize -nostdinc -fstruct-passing -I../../../reference-sm64-decomp/include -I../../../reference-sm64-decomp/build/us -I../../../reference-sm64-decomp/build/us/include -I../../../reference-sm64-decomp/src -I../../../reference-sm64-decomp/src/game -I../../../reference-sm64-decomp/lib/src -I../../../reference-sm64-decomp -I../../../reference-sm64-decomp/include/libc -DVERSION_US=1 -DF3DEX_GBI_2=1 -DF3DEX_GBI_SHARED=1 -D_FINALROM=1 -DTARGET_N64=1 -DNON_MATCHING=1 -DAVOID_UB=1 -D_LANGUAGE_C=1 *)
...
Module Info.
  ...
  Definition source_file := "../../../reference-sm64-decomp/lib/src/__osSiRawStartDma.c".
...
Definition ___osSiDeviceBusy : ident := $"__osSiDeviceBusy".
Definition ___osSiRawStartDma : ident := $"__osSiRawStartDma".
Definition _addr : ident := $"addr".
Definition _dir : ident := $"dir".
Definition _main : ident := $"main".
Definition _osInvalDCache : ident := $"osInvalDCache".
Definition _osVirtualToPhysical : ident := $"osVirtualToPhysical".
Definition _osWritebackDCache : ident := $"osWritebackDCache".
Definition _t'1 : ident := 128%positive.
Definition _t'2 : ident := 129%positive.

Definition f___osSiRawStartDma := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := ((_dir, tint) :: (_addr, (tptr tvoid)) :: nil);
  fn_vars := nil;
...
(Ssequence
  (Ssequence
    (Scall (Some _t'1)
      (Evar ___osSiDeviceBusy (Tfunction nil tint cc_default)) nil)
    (Sifthenelse (Etempvar _t'1 tint)
      (Sreturn (Some (Eunop Oneg (Econst_int (Int.repr 1) tint) tint)))
      Sskip))
  (Ssequence
    (Sifthenelse (Ebinop Oeq (Etempvar _dir tint)
                   (Econst_int (Int.repr 1) tint) tint)
      (Scall None
        (Evar _osWritebackDCache (Tfunction ((tptr tvoid) :: tuint :: nil)
                                   tvoid cc_default))
        ((Etempvar _addr (tptr tvoid)) :: (Econst_int (Int.repr 64) tint) ::
         nil))
      Sskip)
    (Ssequence
      (Ssequence
        (Scall (Some _t'2)
          (Evar _osVirtualToPhysical (Tfunction ((tptr tvoid) :: nil) tuint
                                       cc_default))
          ((Etempvar _addr (tptr tvoid)) :: nil))
        (Sbuiltin None (EF_vstore Mint32)
          ((tptr (tvolatile tuint)) :: (tvolatile tuint) :: nil)
          ((Eaddrof
             (Ederef
               (Ecast
                 (Ebinop Oor
                   (Ecast
                     (Ebinop Oadd (Econst_int (Int.repr 75497472) tint)
                       (Econst_int (Int.repr 0) tint) tint) tuint)
                   (Econst_int (Int.repr (-1610612736)) tuint) tuint)
                 (tptr (tvolatile tuint))) (tvolatile tuint))
             (tptr (tvolatile tuint))) ::
           (Ecast (Etempvar _t'2 tuint) tuint) :: nil)))
      (Ssequence
        (Sifthenelse (Ebinop Oeq (Etempvar _dir tint)
            ...
            ((Eaddrof
               (Ederef
                 (Ecast
                   ...
                   (tptr (tvolatile tuint))) (tvolatile tuint))
               (tptr (tvolatile tuint))) ::
             (Ecast (Econst_int (Int.repr 532678592) tint) tuint) :: nil))
          (Sbuiltin None (EF_vstore Mint32)
            ((tptr (tvolatile tuint)) :: (tvolatile tuint) :: nil)
            ((Eaddrof
               (Ederef
        ...
        (Ssequence
          (Sifthenelse (Ebinop Oeq (Etempvar _dir tint)
                         (Econst_int (Int.repr 0) tint) tint)
            (Scall None
              (Evar _osInvalDCache (Tfunction ((tptr tvoid) :: tuint :: nil)
                                     tvoid cc_default))
...
((___compcert_va_int32,
 ...
 (_osVirtualToPhysical,
   Gfun(External (EF_external "osVirtualToPhysical"
                   (mksignature (AST.Xptr :: nil) AST.Xint cc_default))
     ((tptr tvoid) :: nil) tuint cc_default)) ::
 (_osInvalDCache,
   Gfun(External (EF_external "osInvalDCache"
     ...
     cc_default)) ::
 (_osWritebackDCache,
   Gfun(External (EF_external "osWritebackDCache"
                   (mksignature (AST.Xptr :: AST.Xint :: nil) AST.Xvoid
                     cc_default)) ((tptr tvoid) :: tuint :: nil) tvoid
     cc_default)) ::
 (___osSiDeviceBusy,
   Gfun(External (EF_external "__osSiDeviceBusy"
                   (mksignature nil AST.Xint cc_default)) nil tint
     cc_default)) ::
 (___osSiRawStartDma, Gfun(Internal f___osSiRawStartDma)) :: nil).

Definition public_idents : list ident :=
(___osSiRawStartDma :: ___osSiDeviceBusy :: _osWritebackDCache ::
 _osInvalDCache :: _osVirtualToPhysical :: ___builtin_debug ::
