...
This checklist is organized by decision value rather than research chronology.
A checked item is a kernel-checked result, generated-source receipt, or
explicitly scoped runtime observation. It is not stronger than the caveats
stated in that item.
...
- [ ] Complete the remaining work in the seven-step linked gap-closure tranche. Completed substeps are listed under **Completed tasks → Linked-program and gap-closure foundations**.
...
- [ ] Prove which JP raw-platform cases are reachable and bound every reachable
  ...
  and continuation once a suitable payload is installed.  Completed supporting results are listed under **Completed tasks → JP stale-platform lineage and destination continuation**.
...
- [ ] Prove or refute the five narrow Ink obligations:
  ...
  Completed supporting results are listed under **Completed tasks → Ink, quicksand, and clean-entry reductions**.
