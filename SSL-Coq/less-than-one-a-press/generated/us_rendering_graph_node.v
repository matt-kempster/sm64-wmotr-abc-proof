(* ======================================================================
   ...
   Link hygiene:    private __stringlit_N atoms prefixed with us_rendering_graph_node
   ====================================================================== *)
...
Definition __478 : ident := $"_478".
Definition __484 : ident := $"_484".
Definition __506 : ident := $"_506".
...
Definition ___stringlit_1 : ident := $"__us_rendering_graph_node_stringlit_1".
...
Definition _guLookAtReflect : ident := $"guLookAtReflect".
...
Definition _lookAt : ident := $"lookAt".
...
Definition v_lookAt := {|
  gvar_info := (Tstruct __506 noattr);
...
Definition f_geo_process_master_list_sub := {|
  ...
  fn_vars := ((_lMtx, (Tunion __472 noattr)) :: nil);
  fn_temps := ((_currList, (tptr (Tstruct _DisplayListNode noattr))) ::
               ...
               (_t'1, (tptr (Tunion __549 noattr))) :: (_t'14, tshort) ::
...
(Ssequence
  ...
  (Ssequence
    ...
    (Ssequence
      ...
      (Ssequence
        (Scall None
          (Evar _guLookAtReflect (Tfunction
                                   ((tptr (Tunion __472 noattr)) ::
                                    (tptr (Tstruct __506 noattr)) ::
                                    tfloat :: tfloat :: tfloat :: tfloat ::
                                    tfloat :: tfloat :: tfloat :: tfloat ::
                                    tfloat :: nil) tvoid cc_default))
          ((Eaddrof (Evar _lMtx (Tunion __472 noattr))
             (tptr (Tunion __472 noattr))) ::
           (Eaddrof (Evar _lookAt (Tstruct __506 noattr))
             (tptr (Tstruct __506 noattr))) ::
                ...
                (Ssequence
                  (Ssequence
                    ...
                    (Sassign
                      (Evar _gDisplayListHead (tptr (Tunion __549 noattr)))
                      (Ebinop Oadd
                        (Etempvar _t'1 (tptr (Tunion __549 noattr)))
                        (Econst_int (Int.repr 1) tint)
                  ...
                  (Sassign
                    ...
                    (Ebinop Oor
                      (Ecast
                        (Ebinop Oshl
                          (Ebinop Oand
                            (Ecast (Econst_int (Int.repr 217) tint) tuint)
                            (Ebinop Osub
                              (Ebinop Oshl (Econst_int (Int.repr 1) tint)
                                (Econst_int (Int.repr 8) tint) tint)
                              (Econst_int (Int.repr 1) tint) tint) tuint)
...
Definition f_geo_append_display_list := {|
  ...
  fn_temps := ((__g, (tptr (Tunion __549 noattr))) ::
               (__g__1, (tptr (Tunion __549 noattr))) ::
               (_listNode, (tptr (Tstruct _DisplayListNode noattr))) ::
               (_t'3, (tptr tvoid)) ::
               (_t'2, (tptr (Tunion __549 noattr))) ::
               (_t'1, (tptr (Tunion __549 noattr))) ::
               (_t'13, (tptr (Tstruct _AllocOnlyPool noattr))) ::
               (_t'12, (tptr (Tunion __472 noattr))) :: (_t'11, tshort) ::
               (_t'10, (tptr (Tstruct _GraphNodeMasterList noattr))) ::
               (_t'9, (tptr (Tstruct _DisplayListNode noattr))) ::
               ...
               (_t'5, (tptr (Tstruct _GraphNodeMasterList noattr))) ::
               (_t'4, (tptr (Tstruct _GraphNodeMasterList noattr))) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Ssequence
      ...
      (Ssequence
        (Sassign
          ...
          (Ebinop Oor
            (Ebinop Oor
              (Ebinop Oor
                (Ecast
                  (Ebinop Oshl
                    (Ebinop Oand
                      (Ecast (Econst_int (Int.repr 220) tint) tuint)
                      (Ebinop Osub
                        (Ebinop Oshl (Econst_int (Int.repr 1) tint)
                          (Econst_int (Int.repr 8) tint) tint)
                        (Econst_int (Int.repr 1) tint) tint) tuint)
                ...
                (Ecast
                  (Ebinop Oshl
                    (Ebinop Oand
                      (Ecast
                        (Ebinop Odiv
                          (Ebinop Osub (Esizeof (Tunion __484 noattr) tuint)
            ...
            (Ecast
              (Ebinop Oshl
                (Ebinop Oand (Ecast (Econst_int (Int.repr 10) tint) tuint)
                  (Ebinop Osub
                    (Ebinop Oshl (Econst_int (Int.repr 1) tint)
                      (Econst_int (Int.repr 8) tint) tint)
                    (Econst_int (Int.repr 1) tint) tint) tuint)
        ...
        (Sassign
          ...
          (Ecast
            (Eaddrof (Evar _lookAt (Tstruct __506 noattr))
              (tptr (Tstruct __506 noattr))) tuint))))
    (Ssequence
      (Ssequence
        (Ssequence
        ...
        (Sassign
          ...
          (Ecast
            (Ebinop Oadd
              (Ecast
                (Eaddrof (Evar _lookAt (Tstruct __506 noattr))
                  (tptr (Tstruct __506 noattr))) (tptr tuchar))
              (Econst_int (Int.repr 16) tint) (tptr tuchar)) tuint)))))
  (Ssequence
    (Sset _t'4
            ...
            (Scall (Some _t'3)
              (Evar _alloc_only_pool_alloc (Tfunction
                                             ((tptr (Tstruct _AllocOnlyPool noattr)) ::
                                              tint :: nil) (tptr tvoid)
                                             cc_default))
              ((Etempvar _t'13 (tptr (Tstruct _AllocOnlyPool noattr))) ::
               (Esizeof (Tstruct _DisplayListNode noattr) tuint) :: nil)))
          (Sset _listNode (Etempvar _t'3 (tptr tvoid))))
        (Ssequence
          (Ssequence
            ...
            (Ssequence
              ...
              (Sassign
                (Efield
                  ...
                  (tptr (Tunion __472 noattr)))
                (Etempvar _t'12 (tptr (Tunion __472 noattr))))))
          (Ssequence
            (Sassign
              (Efield
                (Ederef
                  (Etempvar _listNode (tptr (Tstruct _DisplayListNode noattr)))
                  (Tstruct _DisplayListNode noattr)) _displayList
                        ...
                        (Sassign
                          (Ederef
                            (Ebinop Oadd
                              (Efield
                                (Ederef
                                  (Etempvar _t'10 (tptr (Tstruct _GraphNodeMasterList noattr)))
                                  (Tstruct _GraphNodeMasterList noattr))
                                _listHeads
                                (tarray (tptr (Tstruct _DisplayListNode noattr)) 8))
                              (Etempvar _layer tshort)
                      ...
                      (Ssequence
                        ...
                        (Ssequence
                          ...
                          (Sassign
                            (Efield
                              (Ederef
                                (Etempvar _t'9 (tptr (Tstruct _DisplayListNode noattr)))
                                (Tstruct _DisplayListNode noattr)) _next
                              (tptr (Tstruct _DisplayListNode noattr)))
                            (Etempvar _listNode (tptr (Tstruct _DisplayListNode noattr)))))))))
                (Ssequence
                  ...
                  (Sassign
                    (Ederef
                      (Ebinop Oadd
                        (Efield
                          (Ederef
                            (Etempvar _t'5 (tptr (Tstruct _GraphNodeMasterList noattr)))
                    ...
                    (Ssequence
                      (Sassign
                        (Efield
                          (Efield
                            (Ederef
                              (Etempvar __g (tptr (Tunion __549 noattr)))
                              (Tunion __549 noattr)) _words
                            (Tstruct __547 noattr)) _w0 tuint)
                        (Ebinop Oor
                          (Ebinop Oor
                            (Ecast
                              (Ebinop Oshl
                                (Ebinop Oand
                                  (Ecast (Econst_int (Int.repr 219) tint)
                                    tuint)
                                  (Ebinop Osub
                                    (Ebinop Oshl
                                      (Econst_int (Int.repr 1) tint)
                            ...
                            (Ecast
                              (Ebinop Oshl
                                (Ebinop Oand
                                  (Ecast (Econst_int (Int.repr 14) tint)
                                    tuint)
                                  (Ebinop Osub
                                    (Ebinop Oshl
                                      (Econst_int (Int.repr 1) tint)
                            ...
                            (Ebinop Oor
                              (Ebinop Oor
                                (Ecast
                                  (Ebinop Oshl
                                    (Ebinop Oand
                                      (Ecast (Econst_int (Int.repr 218) tint)
                                        tuint)
                                      (Ebinop Osub
                                        (Ebinop Oshl
                                          (Econst_int (Int.repr 1) tint)
                                    ...
                                    (Ebinop Oand
                                      ...
                                      (Ebinop Osub
                                        (Ebinop Oshl
                                          ...
                                          tint)
                                        (Econst_int (Int.repr 1) tint) tint)
                                      tuint) (Econst_int (Int.repr 19) tint)
                                    tuint) tuint) tuint)
                              (Ecast
                                (Ebinop Oshl
                                  (Ebinop Oand
               ...
               (_t'15,
                (tptr (Tfunction
                        (tint :: (tptr (Tstruct _GraphNode noattr)) ::
                         (tptr tvoid) :: nil) (tptr (Tunion __549 noattr))
                        cc_default))) ::
               (_t'14,
                (tptr (Tfunction
                        (tint :: (tptr (Tstruct _GraphNode noattr)) ::
                      ...
                      (Efield
                        (Efield
                          (Ederef (Etempvar __g (tptr (Tunion __549 noattr)))
                            (Tunion __549 noattr)) _words
                          (Tstruct __547 noattr)) _w1 tuint)
                      (Ecast (Etempvar _t'6 tushort) tuint)))))
              (Ssequence
                (Ssequence
                  (Ssequence
                    (Ssequence
                        ...
                        (Ebinop Oor
                          ...
                          (Ecast
                            (Ebinop Oshl
                              (Ebinop Oand
                                (Ecast
                                  (Ebinop Odiv (Econst_int (Int.repr 0) tint)
                                    (Econst_int (Int.repr 8) tint) tint)
                                  tuint)
                                (Ebinop Osub
                                  (Ebinop Oshl (Econst_int (Int.repr 1) tint)
                  ...
                  (Ebinop Oor
                    (Ebinop Oor
                      (Ecast
                        (Ebinop Oshl
                          (Ebinop Oand
                            (Ecast (Econst_int (Int.repr 218) tint) tuint)
                            (Ebinop Osub
                              (Ebinop Oshl (Econst_int (Int.repr 1) tint)
                                (Econst_int (Int.repr 8) tint) tint)
                              (Econst_int (Int.repr 1) tint) tint) tuint)
                          ...
                          (Ebinop Oand
                            ...
                            (Ebinop Osub
                              (Ebinop Oshl (Econst_int (Int.repr 1) tint)
                                (Econst_int (Int.repr 5) tint) tint)
                              (Econst_int (Int.repr 1) tint) tint) tuint)
                          (Econst_int (Int.repr 19) tint) tuint) tuint)
                      tuint)
                    (Ecast
                      (Ebinop Oshl
                        (Ebinop Oand
...
Definition f_geo_process_generated_list := {|
  ...
  fn_vars := nil;
  fn_temps := ((_list, (tptr (Tunion __549 noattr))) ::
               (_t'1, (tptr (Tunion __549 noattr))) :: (_t'7, tshort) ::
               (_t'6,
                (tptr (Tfunction
                        (tint :: (tptr (Tstruct _GraphNode noattr)) ::
                         (tptr tvoid) :: nil) (tptr (Tunion __549 noattr))
    ...
    (Sifthenelse (Ebinop One
      ...
      (Ssequence
        (Ssequence
          ...
          (Sset _list (Etempvar _t'1 (tptr (Tunion __549 noattr)))))
        (Sifthenelse (Ebinop One
                       (Etempvar _list (tptr (Tunion __549 noattr)))
                       (Ecast (Econst_int (Int.repr 0) tint) (tptr tvoid))
                       tint)
          (Ssequence
            (Sset _t'5
            ...
            (Scall None
              ...
              ((Ecast
                 (Ebinop Oand
                   (Ecast (Etempvar _list (tptr (Tunion __549 noattr)))
                     tuint) (Econst_int (Int.repr 536870911) tint) tuint)
                 (tptr tvoid)) ::
               (Ebinop Oshr (Etempvar _t'5 tshort)
                 (Econst_int (Int.repr 8) tint) tint) :: nil)))
...
Definition f_geo_process_background := {|
  ...
  fn_vars := nil;
  fn_temps := ((_list, (tptr (Tunion __549 noattr))) ::
               (_gfxStart, (tptr (Tunion __549 noattr))) ::
               (_gfx, (tptr (Tunion __549 noattr))) ::
               (__g, (tptr (Tunion __549 noattr))) ::
               (__g__1, (tptr (Tunion __549 noattr))) ::
               (__g__2, (tptr (Tunion __549 noattr))) ::
               (__g__3, (tptr (Tunion __549 noattr))) ::
               ...
               (_t'3, (tptr (Tunion __549 noattr))) ::
               (_t'2, (tptr tvoid)) ::
               (_t'1, (tptr (Tunion __549 noattr))) :: (_t'17, tshort) ::
               (_t'16,
                (tptr (Tfunction
                        (tint :: (tptr (Tstruct _GraphNode noattr)) ::
                         (tptr tvoid) :: nil) (tptr (Tunion __549 noattr))
  ...
  (Ssequence
    (Ssequence
      ...
      (Sifthenelse (Ebinop One
        ...
        Sskip))
    (Ssequence
      (Sifthenelse (Ebinop One (Etempvar _list (tptr (Tunion __549 noattr)))
                     (Ecast (Econst_int (Int.repr 0) tint) (tptr tvoid))
                     tint)
        (Ssequence
          (Sset _t'14
          ...
          (Scall None
            ...
            ((Ecast
               (Ebinop Oand
                 (Ecast (Etempvar _list (tptr (Tunion __549 noattr))) tuint)
              ...
              (Ssequence
                (Scall (Some _t'2)
                  (Evar _alloc_display_list (Tfunction (tuint :: nil)
                                              (tptr tvoid) cc_default))
                  ((Ebinop Omul (Esizeof (Tunion __549 noattr) tuint)
                     (Econst_int (Int.repr 7) tint) tuint) :: nil))
                (Sset _gfxStart (Etempvar _t'2 (tptr tvoid))))
              (Ssequence
                (Sset _gfx (Etempvar _gfxStart (tptr (Tunion __549 noattr))))
                (Ssequence
                  (Ssequence
                    (Ssequence
                      (Ssequence
                        (Sset _t'3
                          (Etempvar _gfx (tptr (Tunion __549 noattr))))
                        (Sset _gfx
                          (Ebinop Oadd
                            (Etempvar _t'3 (tptr (Tunion __549 noattr)))
                            (Econst_int (Int.repr 1) tint)
...
Definition f_geo_process_shadow := {|
  ...
  fn_temps := ((_shadowList, (tptr (Tunion __549 noattr))) ::
               ...
               (_t'6, (tptr tvoid)) ::
               (_t'5, (tptr (Tunion __549 noattr))) :: (_t'4, tint) ::
            ...
            (Ssequence
              (Ssequence
                ...
                (Sset _shadowList
                  (Etempvar _t'5 (tptr (Tunion __549 noattr)))))
              (Sifthenelse (Ebinop One
                             (Etempvar _shadowList (tptr (Tunion __549 noattr)))
                             (Ecast (Econst_int (Int.repr 0) tint)
                               (tptr tvoid)) tint)
                (Ssequence
                  (Ssequence
...
Definition f_geo_process_held_object := {|
  ...
  fn_temps := ((_mtx, (tptr (Tunion __472 noattr))) ::
               (__g, (tptr (Tunion __549 noattr))) ::
               (__g__1, (tptr (Tunion __549 noattr))) ::
               (_hasAnimation, tint) :: (_t'4, tint) ::
               (_t'3, (tptr (Tunion __549 noattr))) ::
               (_t'2, (tptr (Tunion __549 noattr))) ::
               (_t'1, (tptr tvoid)) :: (_t'58, tshort) ::
               (_t'57,
                (tptr (Tfunction
                        (tint :: (tptr (Tstruct _GraphNode noattr)) ::
                         (tptr tvoid) :: nil) (tptr (Tunion __549 noattr))
               ...
               (_t'56,
                (tptr (Tfunction
                        (tint :: (tptr (Tstruct _GraphNode noattr)) ::
                         (tptr tvoid) :: nil) (tptr (Tunion __549 noattr))
                        cc_default))) ::
               (_t'55, (tptr (Tstruct _GraphNode noattr))) ::
               (_t'54, (tptr (Tstruct _Object noattr))) ::
               (_t'53, (tptr (Tstruct _Object noattr))) :: (_t'52, tshort) ::
               (_t'51, (tptr (Tstruct _Object noattr))) :: (_t'50, tshort) ::
               (_t'49, tshort) :: (_t'48, tshort) ::
               (_t'47, (tptr (tarray (tarray tfloat 4) 4))) ::
               (_t'46, (tptr (Tstruct _GraphNodeObject noattr))) ::
               (_t'45, tshort) :: (_t'44, tfloat) :: (_t'43, tshort) ::
               (_t'42, tshort) :: (_t'41, tfloat) :: (_t'40, tshort) ::
               (_t'39, tshort) :: (_t'38, tfloat) :: (_t'37, tshort) ::
               (_t'36, tshort) :: (_t'35, tshort) :: (_t'34, tshort) ::
               (_t'33, (tptr (Tstruct _Object noattr))) :: (_t'32, tshort) ::
               (_t'31, tshort) :: (_t'30, tshort) ::
               (_t'29,
                (tptr (Tfunction
                        (tint :: (tptr (Tstruct _GraphNode noattr)) ::
                         (tptr tvoid) :: nil) (tptr (Tunion __549 noattr))
               ...
               (_t'28,
                (tptr (Tfunction
                        (tint :: (tptr (Tstruct _GraphNode noattr)) ::
                         (tptr tvoid) :: nil) (tptr (Tunion __549 noattr))
                        cc_default))) :: (_t'27, tshort) ::
               (_t'26, tshort) :: (_t'25, tshort) :: (_t'24, tuchar) ::
               (_t'23, tuchar) :: (_t'22, tshort) :: (_t'21, tfloat) ::
               (_t'20, (tptr tushort)) :: (_t'19, (tptr tshort)) ::
               (_t'18, (tptr (Tstruct _Object noattr))) ::
               (_t'17, (tptr (Tstruct _Animation noattr))) ::
               (_t'16, (tptr (Tstruct _Object noattr))) ::
               (_t'15, (tptr (Tstruct _GraphNode noattr))) ::
               (_t'14, (tptr (Tstruct _Object noattr))) :: (_t'13, tuchar) ::
               (_t'12, tuchar) :: (_t'11, tshort) :: (_t'10, tfloat) ::
               (_t'9, (tptr tushort)) :: (_t'8, (tptr tshort)) ::
               (_t'7, tshort) ::
               (_t'6, (tptr (Tstruct _GraphNode noattr))) ::
                    ...
                    (Ebinop Oshl
                      (Ebinop Oand
                        (Ecast
                          (Ebinop Odiv
                            (Ebinop Osub
                              (Esizeof (Tunion __484 noattr) tuint)
                              (Econst_int (Int.repr 1) tint) tuint)
                            (Econst_int (Int.repr 8) tint) tuint) tuint)
                        (Ebinop Osub
                          (Ebinop Oshl (Econst_int (Int.repr 1) tint)
            ...
            (Sset _t'57
              (Efield
                ...
                (tptr (Tfunction
                        ...
                        cc_default))))
            (Ssequence
              (Sset _t'58 (Evar _gMatStackIndex tshort))
              (Scall None
                (Etempvar _t'57 (tptr (Tfunction
                                        (tint ::
                                         (tptr (Tstruct _GraphNode noattr)) ::
                                         (tptr tvoid) :: nil)
                                        (tptr (Tunion __549 noattr))
              ...
              (Ssequence
                ...
                (Ssequence
                  ...
                  (Sset _t'4
                    (Ecast
                      (Ebinop One
                        (Etempvar _t'55 (tptr (Tstruct _GraphNode noattr)))
                        (Ecast (Econst_int (Int.repr 0) tint) (tptr tvoid))
                        tint) tbool))))
                ...
                (Ssequence
                  ...
                  (Sassign
                    (Ederef
                      (Ebinop Oadd (Evar _translation (tarray tfloat 3))
                        (Econst_int (Int.repr 0) tint) (tptr tfloat)) tfloat)
                    (Ebinop Odiv (Etempvar _t'50 tshort)
                    ...
                    (Sassign
                      (Ederef
                        (Ebinop Oadd (Evar _translation (tarray tfloat 3))
                          (Econst_int (Int.repr 1) tint) (tptr tfloat))
                        tfloat)
                      (Ebinop Odiv (Etempvar _t'49 tshort)
                        (Econst_single (Float32.of_bits (Int.repr 1082130432)) tfloat)
                        tfloat)))
                  (Ssequence
                    (Ssequence
                    ...
                    (Ssequence
                      ...
                      (Ssequence
                        (Ssequence
                          (Sset _t'45 (Evar _gMatStackIndex tshort))
                          (Ssequence
                            (Sset _t'46
                              (Evar _gCurGraphNodeObject (tptr (Tstruct _GraphNodeObject noattr))))
                            (Ssequence
                              (Sset _t'47
                                (Efield
                                  (Ederef
                                    (Etempvar _t'46 (tptr (Tstruct _GraphNodeObject noattr)))
                                    (Tstruct _GraphNodeObject noattr))
                                  _throwMatrix
                                  (tptr (tarray (tarray tfloat 4) 4))))
                              (Scall None
                                ...
                                ((Ederef
                                   (Ebinop Oadd
                                     (Evar _gMatStack (tarray (tarray (tarray tfloat 4) 4) 32))
                                     (Ebinop Oadd (Etempvar _t'45 tshort)
                                       (Econst_int (Int.repr 1) tint) tint)
                                     (tptr (tarray (tarray tfloat 4) 4)))
                                   (tarray (tarray tfloat 4) 4)) ::
                                 (Ederef
                                   (Etempvar _t'47 (tptr (tarray (tarray tfloat 4) 4)))
                                   (tarray (tarray tfloat 4) 4)) :: nil)))))
                        (Ssequence
                          (Ssequence
                            (Sset _t'42 (Evar _gMatStackIndex tshort))
                            (Ssequence
                          ...
                          (Ssequence
                            (Ssequence
                              (Sset _t'39 (Evar _gMatStackIndex tshort))
                              (Ssequence
                            ...
                            (Ssequence
                              (Ssequence
                                (Sset _t'36 (Evar _gMatStackIndex tshort))
                                (Ssequence
                                  (Sset _t'37 (Evar _gMatStackIndex tshort))
                                  (Ssequence
                                    (Sset _t'38
              ...
              (Scall None
                (Evar _geo_process_node_and_siblings (Tfunction
                                                       ((tptr (Tstruct _GraphNode noattr)) ::
                                                        nil) tvoid
                                                       cc_default))
                ((Etempvar _t'6 (tptr (Tstruct _GraphNode noattr))) :: nil)))
            Sskip))))))
|}.
...
(Composite __469 Struct
 ...
 Composite __476 Union
   (Member_plain _vp (Tstruct __474 noattr) ::
    Member_plain _force_structure_alignment tlong :: nil)
   noattr ::
 Composite __478 Struct
   (Member_plain _col (tarray tuchar 3) :: Member_plain _pad1 tuchar ::
    Member_plain _colc (tarray tuchar 3) :: Member_plain _pad2 tuchar ::
    Member_plain _dir (tarray tschar 3) :: Member_plain _pad3 tuchar :: nil)
   noattr ::
 Composite __484 Union
   (Member_plain _l (Tstruct __478 noattr) ::
    Member_plain _force_structure_alignment (tarray tlong 2) :: nil)
   noattr ::
 Composite __506 Struct
   (Member_plain _l (tarray (Tunion __484 noattr) 2) :: nil)
   noattr ::
    ...
    Member_plain _func
      (tptr (Tfunction
              (tint :: (tptr (Tstruct _GraphNode noattr)) :: (tptr tvoid) ::
               nil) (tptr (Tunion __549 noattr)) cc_default)) :: nil)
   noattr ::
 ...
 (_guOrtho,
   Gfun(External (EF_external "guOrtho"
     ...
     ((tptr (Tunion __472 noattr)) :: tfloat :: tfloat :: tfloat :: tfloat ::
      tfloat :: tfloat :: tfloat :: nil) tvoid cc_default)) ::
 (_guLookAtReflect,
   Gfun(External (EF_external "guLookAtReflect"
                   (mksignature
                     (AST.Xptr :: AST.Xptr :: AST.Xsingle :: AST.Xsingle ::
                      AST.Xsingle :: AST.Xsingle :: AST.Xsingle ::
                      AST.Xsingle :: AST.Xsingle :: AST.Xsingle ::
                      AST.Xsingle :: nil) AST.Xvoid cc_default))
     ((tptr (Tunion __472 noattr)) :: (tptr (Tstruct __506 noattr)) ::
...
(_geo_process_root :: _geo_process_node_and_siblings ::
 ...
 _geo_set_animation_globals :: _lookAt :: _gAreaUpdateCounter ::
 ...
 _main_pool_free :: _segmented_to_virtual :: _guLookAtReflect :: _guOrtho ::
 _guPerspective :: ___builtin_debug :: ___builtin_sync_fetch_and_add ::
