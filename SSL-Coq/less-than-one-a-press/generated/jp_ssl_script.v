(* ======================================================================
   ...
   Link hygiene:    private __stringlit_N atoms prefixed with jp_ssl_script
   ====================================================================== *)
...
Module Info.
  ...
  Definition source_file := "build/pinned-sm64/levels/ssl/script.c".
