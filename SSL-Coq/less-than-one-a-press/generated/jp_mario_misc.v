(* ======================================================================
   ...
   Link hygiene:    private __stringlit_N atoms prefixed with jp_mario_misc
   ====================================================================== *)
...
Module Info.
  ...
  Definition source_file := "build/pinned-sm64/src/game/mario_misc.c".
...
Definition f_geo_draw_mario_head_goddard := {|
  ...
  fn_vars := nil;
  fn_temps := ((_gfx, (tptr (Tunion __512 noattr))) :: (_sfx, tshort) ::
               (_asGenerated, (tptr (Tstruct _GraphNodeGenerated noattr))) ::
               (_transform, (tptr (tarray (tarray tfloat 4) 4))) ::
               (_t'3, tint) :: (_t'2, (tptr (Tunion __512 noattr))) ::
               (_t'1, tint) :: (_t'9, tuchar) ::
               (_t'8, (tptr (Tstruct __319 noattr))) ::
               (_t'7, (tptr (Tstruct _Controller noattr))) ::
               (_t'6, (tptr (Tstruct __319 noattr))) ::
                ...
                (Ssequence
                  ...
                  (Ssequence
                    ...
                    (Sifthenelse (Ebinop One
                                   (Etempvar _t'8 (tptr (Tstruct __319 noattr)))
                  ...
                  (Ssequence
                    ...
                    (Ssequence
                      ...
                      (Scall None
                        ...
                        ((Etempvar _t'6 (tptr (Tstruct __319 noattr))) ::
                         nil))))
                  Sskip))
              (Ssequence
                (Ssequence
                  ...
                  (Sset _gfx
                    (Ecast
                      (Ebinop Oor
                        ...
                        tuint) (tptr (Tunion __512 noattr)))))
                (Ssequence
                  (Sassign
...
Definition f_make_gfx_mario_alpha := {|
  ...
  fn_temps := ((_gfx, (tptr (Tunion __512 noattr))) ::
               (_gfxHead, (tptr (Tunion __512 noattr))) ::
  ...
  (Ssequence
    (Sifthenelse (Ebinop Oeq (Etempvar _alpha tshort)
      ...
      (Ssequence
        ...
        (Ssequence
          ...
          (Sset _gfx (Etempvar _gfxHead (tptr (Tunion __512 noattr))))))
      (Ssequence
        (Ssequence
          (Sset _t'5
            (Efield
        ...
        (Ssequence
          ...
          (Ssequence
            ...
            (Ssequence
              (Ssequence
                (Ssequence
                  (Sset _t'3 (Etempvar _gfx (tptr (Tunion __512 noattr))))
                  (Sset _gfx
    ...
    (Ssequence
      (Ssequence
        (Ssequence
          (Ssequence
            (Sset _t'4 (Etempvar _gfx (tptr (Tunion __512 noattr))))
            (Sset _gfx
      ...
      (Ssequence
        ...
        (Sreturn (Some (Etempvar _gfxHead (tptr (Tunion __512 noattr)))))))))
|}.
...
Definition f_geo_mirror_mario_set_alpha := {|
  ...
  fn_temps := ((_gfx, (tptr (Tunion __512 noattr))) ::
               ...
               (_alpha, tshort) :: (_t'2, (tptr (Tunion __512 noattr))) ::
        ...
        (Sifthenelse (Ebinop Oeq (Etempvar _callContext tint)
          ...
          (Ssequence
            ...
            (Ssequence
              ...
              (Sset _gfx (Etempvar _t'2 (tptr (Tunion __512 noattr))))))
          Sskip)
        (Sreturn (Some (Etempvar _gfx (tptr (Tunion __512 noattr)))))))))
|}.
...
Definition f_geo_mirror_mario_backface_culling := {|
  ...
  fn_temps := ((_asGenerated, (tptr (Tstruct _GraphNodeGenerated noattr))) ::
               ...
               (__g__5, (tptr (Tunion __512 noattr))) :: (_t'2, tint) ::
               (_t'1, (tptr tvoid)) ::
                    ...
                    (Ssequence
                      ...
                      (Ssequence
                        ...
                        (Sassign
                          ...
                          (Ecast (Econst_int (Int.repr 8192) tint) tuint))))
                    (Ssequence
                      (Ssequence
                        (Sset __g__1
                          (Ecast
                            ...
                            (Efield
                              (Efield
                                (Ederef
                                  ...
                                  (Tunion __512 noattr)) _words
                                (Tstruct __510 noattr)) _w1 tuint)
                            (Ecast (Econst_int (Int.repr 4096) tint) tuint))))
                      (Ssequence
                        (Sset __g__2
                          (Ecast
                            (Ebinop Oadd
...
((___compcert_va_int32,
 ...
 (_gdm_gettestdl,
   Gfun(External (EF_external "gdm_gettestdl"
                   (mksignature (AST.Xint :: nil) AST.Xptr cc_default))
     (tint :: nil) (tptr (Tunion __512 noattr)) cc_default)) ::
