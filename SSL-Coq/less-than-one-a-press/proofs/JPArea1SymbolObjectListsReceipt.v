(** One-lookup JP [gObjectLists] source receipt and symbol transport. *)
...
Lemma jp_object_list_processor_is_object_lists_source_unit :
  nIn jp_object_list_processor.prog jp_units.
Proof. unfold jp_units. do 13 right. now left. Qed.

Theorem jp_object_list_processor_gObjectLists_defmap_checked :
  (AST.prog_defmap
      (Ctypes.program_of_program jp_object_list_processor.prog)) !
      jp_object_list_processor._gObjectLists =
    Some (Gvar jp_object_list_processor.v_gObjectLists).
Proof. vm_compute. reflexivity. Qed.

Theorem jp_official_area1_object_lists_pointer_symbol_exists :
  exists block,
    Genv.find_symbol (Clight.globalenv jp_official_cleaned_slice)
      jp_object_list_processor._gObjectLists = Some block.
Proof.
  eapply (jp_source_definition_has_official_symbol
    jp_object_list_processor.prog).
  - exact jp_object_list_processor_is_object_lists_source_unit.
  - pose proof jp_object_list_processor_gObjectLists_defmap_checked as H.
