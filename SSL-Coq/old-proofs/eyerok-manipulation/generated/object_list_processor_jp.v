(* ======================================================================
   ...
   From source: build/source/object_list_processor.c
...
Module Info.
  ...
  Definition source_file := "build/source/object_list_processor.c".
                            ...
                            (Sassign
                              (Ederef
                                (Ebinop Oadd
                                  ...
                                  (tptr tint)) tint) (Etempvar _t'15 tuint)))
                          (Ssequence
                            (Ssequence
                              (Sset _t'14
                                (Efield
...
(_update_objects :: _unload_deactivated_objects ::
 ...
 _apply_mario_platform_displacement :: _update_mario_platform ::
 _obj_copy_pos_and_angle :: _spawn_object_at_origin ::
 _detect_object_collisions :: _execute_mario_action :: _gMarioStates ::
 _clear_dynamic_surfaces :: _cur_obj_update :: _stub_behavior_script_2 ::
