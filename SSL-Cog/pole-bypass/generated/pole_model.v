(* ======================================================================
   ...
   From source: inputs/pole_model.c
...
Module Info.
  ...
  Definition source_file := "inputs/pole_model.c".
  Definition normalized := true.
End Info.

Definition _PoleRouteState : ident := $"PoleRouteState".
...
Definition _aPressed : ident := $"aPressed".
Definition _aPresses : ident := $"aPresses".
Definition _climbToTop : ident := $"climbToTop".
Definition _conservative_pole_push : ident := $"conservative_pole_push".
Definition _forwardSpeed : ident := $"forwardSpeed".
Definition _frames : ident := $"frames".
Definition _main : ident := $"main".
Definition _mode : ident := $"mode".
Definition _one_a_jump_clears_sixth_floor_hole : ident := $"one_a_jump_clears_sixth_floor_hole".
Definition _pole_route_air_frame : ident := $"pole_route_air_frame".
Definition _pole_route_init : ident := $"pole_route_init".
Definition _pole_route_input : ident := $"pole_route_input".
Definition _radialDistance : ident := $"radialDistance".
Definition _soft_bonk_misses_sixth_floor : ident := $"soft_bonk_misses_sixth_floor".
Definition _state : ident := $"state".
Definition _verticalVelocity : ident := $"verticalVelocity".
Definition _y : ident := $"y".
Definition _zPressed : ident := $"zPressed".
...
Definition f_pole_route_init := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_state, (tptr (Tstruct _PoleRouteState noattr))) :: nil);
  fn_vars := nil;
  fn_temps := nil;
  fn_body :=
(Ssequence
  (Sassign
    (Efield
      (Ederef (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
        (Tstruct _PoleRouteState noattr)) _mode tint)
    (Econst_int (Int.repr 0) tint))
  (Ssequence
    (Sassign
      (Efield
        (Ederef (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
          (Tstruct _PoleRouteState noattr)) _radialDistance tint)
      (Econst_int (Int.repr 0) tint))
    (Ssequence
      (Sassign
        (Efield
          (Ederef (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
            (Tstruct _PoleRouteState noattr)) _y tint)
        (Ebinop Osub
          (Ebinop Oadd (Econst_int (Int.repr 3200) tint)
            (Ebinop Omul (Econst_int (Int.repr 92) tint)
      ...
      (Ssequence
        (Sassign
          (Efield
            (Ederef (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
              (Tstruct _PoleRouteState noattr)) _verticalVelocity tint)
          (Econst_int (Int.repr 0) tint))
        (Ssequence
          (Sassign
            (Efield
              (Ederef
                (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
                (Tstruct _PoleRouteState noattr)) _forwardSpeed tint)
            (Econst_int (Int.repr 0) tint))
          (Sassign
            (Efield
              (Ederef
                (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
                (Tstruct _PoleRouteState noattr)) _aPresses tint)
            (Econst_int (Int.repr 0) tint)))))))
|}.

Definition f_pole_route_input := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_state, (tptr (Tstruct _PoleRouteState noattr))) ::
                (_aPressed, tint) :: (_zPressed, tint) ::
                (_climbToTop, tint) :: nil);
  fn_vars := nil;
  fn_temps := ((_t'3, tint) :: (_t'2, tint) :: (_t'1, tint) :: nil);
  fn_body :=
(Ssequence
  (Sifthenelse (Etempvar _aPressed tint)
    (Ssequence
      (Sset _t'3
        (Efield
          (Ederef (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
  ...
  (Ssequence
    ...
    (Sifthenelse (Ebinop Oeq (Etempvar _t'1 tint)
      ...
      (Sifthenelse (Etempvar _aPressed tint)
        ...
        (Sifthenelse (Etempvar _zPressed tint)
          (Ssequence
            (Sassign
              (Efield
                (Ederef
              ...
              (Sassign
                (Efield
                  (Ederef
                    ...
                    (Tstruct _PoleRouteState noattr)) _forwardSpeed tint)
                (Econst_int (Int.repr 2) tint))))
          (Sifthenelse (Etempvar _climbToTop tint)
            (Sassign
              (Efield
                (Ederef
                  (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
              ...
              (Ssequence
                (Sassign
                  (Efield
                    (Ederef
                      (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
                      (Tstruct _PoleRouteState noattr)) _verticalVelocity
                    tint) (Econst_int (Int.repr 62) tint))
                (Sassign
                  (Efield
                    (Ederef
                      (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
...
Definition f_conservative_pole_push := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := ((_radialDistance, tint) :: nil);
  fn_vars := nil;
  fn_temps := nil;
  fn_body :=
(Ssequence
  (Sifthenelse (Ebinop Olt (Etempvar _radialDistance tint)
                 (Econst_int (Int.repr 70) tint) tint)
    (Sreturn (Some (Econst_int (Int.repr 70) tint)))
    Sskip)
  (Sreturn (Some (Etempvar _radialDistance tint))))
|}.

Definition f_pole_route_air_frame := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_state, (tptr (Tstruct _PoleRouteState noattr))) :: nil);
  fn_vars := nil;
  fn_temps := ((_t'2, tint) :: (_t'1, tint) :: (_t'19, tint) ::
          ...
          (Sset _t'19
            (Efield
              (Ederef
                ...
                (Tstruct _PoleRouteState noattr)) _radialDistance tint))
          (Scall (Some _t'1)
            (Evar _conservative_pole_push (Tfunction (tint :: nil) tint
                                            cc_default))
            ((Etempvar _t'19 tint) :: nil)))
        (Sassign
          (Efield
            (Ederef (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
              (Tstruct _PoleRouteState noattr)) _radialDistance tint)
            ...
            (Sassign
              (Efield
                (Ederef
                  (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
                  (Tstruct _PoleRouteState noattr)) _radialDistance tint)
              (Ebinop Oadd (Etempvar _t'17 tint) (Etempvar _t'18 tint) tint))))
        (Ssequence
          (Ssequence
            (Sset _t'15
              (Efield
              ...
              (Sassign
                (Efield
                  (Ederef
                    (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
                    (Tstruct _PoleRouteState noattr)) _y tint)
                (Ebinop Oadd (Etempvar _t'15 tint) (Etempvar _t'16 tint)
                  tint))))
          (Ssequence
            (Ssequence
              (Sset _t'14
            ...
            (Ssequence
              ...
              (Sifthenelse (Ebinop Olt (Etempvar _t'12 tint)
                             (Econst_int (Int.repr 3942) tint) tint)
                (Sassign
                  (Efield
                    (Ederef
                      (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
                ...
                (Ssequence
                  (Sset _t'13
                    (Efield
                      (Ederef
                        (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
                        (Tstruct _PoleRouteState noattr)) _radialDistance
                      tint))
              ...
              (Sassign
                (Efield
                  (Ederef
                    (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
                    (Tstruct _PoleRouteState noattr)) _radialDistance tint)
                (Ebinop Oadd (Etempvar _t'10 tint) (Etempvar _t'11 tint)
                  tint))))
          (Ssequence
            (Ssequence
              (Sset _t'8
                ...
                (Sassign
                  (Efield
                    (Ederef
                      (Etempvar _state (tptr (Tstruct _PoleRouteState noattr)))
                      (Tstruct _PoleRouteState noattr)) _y tint)
                  (Ebinop Oadd (Etempvar _t'8 tint) (Etempvar _t'9 tint)
                    tint))))
            (Ssequence
              (Ssequence
                (Sset _t'7
                ...
                (Ssequence
                  ...
                  (Sifthenelse (Ebinop Oge (Etempvar _t'5 tint)
                    ...
                    (Ssequence
                      ...
                      (Sset _t'2
                        (Ecast
                          (Ebinop Oge (Etempvar _t'6 tint)
                            (Econst_int (Int.repr 3942) tint) tint) tbool)))
...
Definition f_soft_bonk_misses_sixth_floor := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := nil;
  fn_vars := ((_state, (Tstruct _PoleRouteState noattr)) :: nil);
  fn_temps := ((_frames, tint) :: (_t'2, tint) :: (_t'1, tint) ::
               (_t'5, tint) :: (_t'4, tint) :: (_t'3, tint) :: nil);
  fn_body :=
(Ssequence
  (Sset _frames (Econst_int (Int.repr 0) tint))
  (Ssequence
    (Scall None
      (Evar _pole_route_init (Tfunction
                               ((tptr (Tstruct _PoleRouteState noattr)) ::
                                nil) tvoid cc_default))
      ((Eaddrof (Evar _state (Tstruct _PoleRouteState noattr))
         (tptr (Tstruct _PoleRouteState noattr))) :: nil))
    (Ssequence
      (Scall None
        (Evar _pole_route_input (Tfunction
                                  ((tptr (Tstruct _PoleRouteState noattr)) ::
                                   tint :: tint :: tint :: nil) tvoid
                                  cc_default))
        ((Eaddrof (Evar _state (Tstruct _PoleRouteState noattr))
           (tptr (Tstruct _PoleRouteState noattr))) ::
         (Econst_int (Int.repr 0) tint) :: (Econst_int (Int.repr 1) tint) ::
        ...
        (Sloop
          (Ssequence
            (Ssequence
              (Ssequence
                (Sset _t'5
                  (Efield (Evar _state (Tstruct _PoleRouteState noattr))
                    _mode tint))
                (Sifthenelse (Ebinop Oeq (Etempvar _t'5 tint)
                               (Econst_int (Int.repr 2) tint) tint)
                  (Sset _t'1
                    (Ecast
                      (Ebinop Olt (Etempvar _frames tint)
                        (Econst_int (Int.repr 8) tint) tint) tbool))
                  (Sset _t'1 (Econst_int (Int.repr 0) tint))))
              (Sifthenelse (Etempvar _t'1 tint) Sskip Sbreak))
            (Ssequence
              (Scall None
                (Evar _pole_route_air_frame (Tfunction
                                              ((tptr (Tstruct _PoleRouteState noattr)) ::
                                               nil) tvoid cc_default))
                ((Eaddrof (Evar _state (Tstruct _PoleRouteState noattr))
                   (tptr (Tstruct _PoleRouteState noattr))) :: nil))
              (Sset _frames
                (Ebinop Oadd (Etempvar _frames tint)
                  (Econst_int (Int.repr 1) tint) tint))))
          Sskip)
        (Ssequence
          (Ssequence
            (Sset _t'3
              (Efield (Evar _state (Tstruct _PoleRouteState noattr)) _mode
                tint))
            (Sifthenelse (Ebinop Oeq (Etempvar _t'3 tint)
                           (Econst_int (Int.repr 4) tint) tint)
              (Ssequence
                (Sset _t'4
                  (Efield (Evar _state (Tstruct _PoleRouteState noattr))
                    _radialDistance tint))
                (Sset _t'2
                  (Ecast
                    (Ebinop Olt (Etempvar _t'4 tint)
                      (Econst_int (Int.repr 101) tint) tint) tbool)))
              (Sset _t'2 (Econst_int (Int.repr 0) tint))))
          (Sreturn (Some (Etempvar _t'2 tint))))))))
|}.

Definition f_one_a_jump_clears_sixth_floor_hole := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := nil;
  fn_vars := ((_state, (Tstruct _PoleRouteState noattr)) :: nil);
...
(Composite _PoleRouteState Struct
   (Member_plain _mode tint :: Member_plain _radialDistance tint ::
    Member_plain _y tint :: Member_plain _verticalVelocity tint ::
    Member_plain _forwardSpeed tint :: Member_plain _aPresses tint :: nil)
   noattr :: nil).
...
((___compcert_va_int32,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     (tint :: nil) tvoid
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_pole_route_init, Gfun(Internal f_pole_route_init)) ::
 (_pole_route_input, Gfun(Internal f_pole_route_input)) ::
 (_conservative_pole_push, Gfun(Internal f_conservative_pole_push)) ::
 (_pole_route_air_frame, Gfun(Internal f_pole_route_air_frame)) ::
 (_soft_bonk_misses_sixth_floor, Gfun(Internal f_soft_bonk_misses_sixth_floor)) ::
 (_one_a_jump_clears_sixth_floor_hole, Gfun(Internal f_one_a_jump_clears_sixth_floor_hole)) ::
 nil).

Definition public_idents : list ident :=
(_one_a_jump_clears_sixth_floor_hole :: _soft_bonk_misses_sixth_floor ::
 _pole_route_air_frame :: _conservative_pole_push :: _pole_route_input ::
 _pole_route_init :: ___builtin_debug :: ___builtin_sync_fetch_and_add ::
