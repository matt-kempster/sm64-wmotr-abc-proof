(* ======================================================================
   ...
   From source: ../../../reference-sm64-decomp/src/game/memory.c
...
Module Info.
  ...
  Definition source_file := "../../../reference-sm64-decomp/src/game/memory.c".
...
Definition f_move_segment_table_to_dmem := {|
  ...
  fn_params := nil;
  fn_vars := nil;
  fn_temps := ((_i, tint) :: (__g, (tptr (Tunion __549 noattr))) ::
               (_t'1, (tptr (Tunion __549 noattr))) :: (_t'2, tuint) :: nil);
  fn_body :=
(Ssequence
