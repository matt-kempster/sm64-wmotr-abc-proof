...
Proof.
  ...
  refine (conj (proj1 generated_segmented_to_virtual_first_shift_us_jp) _).
  refine (conj (proj2 generated_segmented_to_virtual_first_shift_us_jp) _).
  refine (conj configured_pointer_width_is_32 _).
  refine (conj pointer_to_uint_cast_preserves_vptr _).
  refine (conj uint_right_shift_of_vptr_is_none _).
  exact (conj us_segmented_first_shift_cannot_eval_from_vptr
    jp_segmented_first_shift_cannot_eval_from_vptr).
Qed.
