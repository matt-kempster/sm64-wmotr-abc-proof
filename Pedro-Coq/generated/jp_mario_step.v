(* ======================================================================
   ...
   Link hygiene:    private __stringlit_N atoms prefixed with jp_mario_step
   ====================================================================== *)
...
Module Info.
  ...
  Definition source_file := "build/pinned-sm64/src/game/mario_step.c".
...
Definition f_mario_update_windy_ground := {|
  ...
  fn_temps := ((_floor, (tptr (Tstruct _Surface noattr))) ::
               ...
               (_t'15, tshort) :: (_t'14, tshort) :: (_t'13, tfloat) ::
               (_t'12, tfloat) :: (_t'11, tfloat) :: (_t'10, tuint) ::
               (_t'9, tuint) :: (_t'8, tfloat) :: (_t'7, tfloat) ::
      ...
      (Sifthenelse (Ebinop Oeq (Etempvar _t'3 tshort)
        ...
        (Ssequence
          (Ssequence
            ...
            (Sset _pushAngle
              (Ecast
                (Ebinop Oshl (Etempvar _t'15 tshort)
                  (Econst_int (Int.repr 8) tint) tint) tshort)))
          (Ssequence
            (Ssequence
              (Sset _t'9
              ...
              (Sifthenelse (Ebinop Oand (Etempvar _t'9 tuint)
                        ...
                        (Sifthenelse (Ebinop Ogt (Etempvar _t'12 tfloat)
                          ...
                          (Ssequence
                            ...
                            (Sset _t'1
                              (Ecast
                                (Ebinop Omul
                                  (Eunop Oneg (Etempvar _t'13 tfloat) tfloat)
                ...
                (Ssequence
                  (Sset _t'10 (Evar _gGlobalTimer tuint))
                  (Sset _pushSpeed
                    (Ebinop Oadd
                      (Econst_single (Float32.of_bits (Int.repr 1078774989)) tfloat)
                      (Ebinop Omod (Etempvar _t'10 tuint)
...
Definition f_apply_vertical_wind := {|
  ...
  fn_temps := ((_maxVelY, tfloat) :: (_offsetY, tfloat) :: (_t'3, tint) ::
               (_t'2, tint) :: (_t'1, tfloat) :: (_t'10, tfloat) ::
               (_t'9, tshort) :: (_t'8, (tptr (Tstruct _Surface noattr))) ::
               (_t'7, tfloat) :: (_t'6, tfloat) ::
                        ...
                        (Ederef
                          (Ebinop Oadd
                            (Efield
                              ...
                              (tarray tfloat 3))
                            (Econst_int (Int.repr 1) tint) (tptr tfloat))
                          tfloat) (Etempvar _maxVelY tfloat))
                      Sskip))
                  Sskip))
              (Ssequence
                (Sset _t'5
