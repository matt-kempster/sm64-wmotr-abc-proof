(* ======================================================================
   ...
   Source:          src/game/mario_actions_stationary.c
   ...
   Link hygiene:    private __stringlit_N atoms prefixed with jp_mario_actions_stationary
   ====================================================================== *)
...
Module Info.
  ...
  Definition source_file := "build/pinned-sm64/src/game/mario_actions_stationary.c".
...
Definition f_act_start_sleeping := {|
  ...
  fn_temps := ((_t'4, tint) :: (_t'3, tuint) :: (_t'2, tuint) ::
               (_t'1, tint) :: (_t'12, tfloat) :: (_t'11, tushort) ::
               (_t'10, (tptr (Tstruct _MarioBodyState noattr))) ::
               (_t'9, (tptr (Tstruct _MarioBodyState noattr))) ::
               (_t'8, tushort) :: (_t'7, tuint) :: (_t'6, tushort) ::
               (_t'5, tushort) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
                      ...
                      (Ssequence
                        (Ssequence
                          ...
                          (Sassign
                            (Efield
                              (Ederef
                                (Etempvar _t'9 (tptr (Tstruct _MarioBodyState noattr)))
                                (Tstruct _MarioBodyState noattr)) _eyeState
                              tschar) (Econst_int (Int.repr 2) tint)))
                        Sbreak))
                    LSnil))))))
...
Definition f_act_sleeping := {|
  ...
  fn_temps := ((_animFrame, tint) :: (_t'10, tshort) :: (_t'9, tint) ::
               ...
               (_t'2, tuint) :: (_t'1, tuint) :: (_t'27, tushort) ::
               (_t'26, tushort) :: (_t'25, tushort) :: (_t'24, tfloat) ::
               (_t'23, tushort) :: (_t'22, tfloat) ::
                      ...
                      (Ssequence
                        (Sifthenelse (Ebinop Oeq (Etempvar _animFrame tint)
                          ...
                          (Ssequence
                            ...
                            (Sset _t'6
                              (Ecast
                                (Eunop Onotbool (Etempvar _t'20 tushort)
                                  tint) tbool)))
            ...
            (Scall None
              ...
              ((Ebinop Oor
               ...
               (Efield
                 (Efield
                   (Efield
                     (Ederef (Etempvar _t'13 (tptr (Tstruct _Object noattr)))
                       (Tstruct _Object noattr)) _header
                     (Tstruct _ObjectNode noattr)) _gfx
                   (Tstruct _GraphNodeObject noattr)) _cameraToObject
                 (tarray tfloat 3)) :: nil)))
