(* ======================================================================
   ...
   Source:          src/game/mario_actions_automatic.c
   ...
   Link hygiene:    private __stringlit_N atoms prefixed with jp_mario_actions_automatic
   ====================================================================== *)
...
Module Info.
  ...
  Definition source_file := "build/pinned-sm64/src/game/mario_actions_automatic.c".
...
Definition f_act_holding_pole := {|
  ...
  fn_temps := ((_marioObj, (tptr (Tstruct _Object noattr))) ::
               ...
               (_t'8, tint) :: (_t'7, (tptr tvoid)) :: (_t'6, tint) ::
               (_t'5, tuint) :: (_t'4, tuint) :: (_t'3, (tptr tvoid)) ::
               (_t'2, tuint) :: (_t'1, tuint) :: (_t'39, tshort) ::
               (_t'38, tushort) :: (_t'37, tushort) :: (_t'36, tfloat) ::
               (_t'35, (tptr (Tstruct _Object noattr))) ::
               (_t'34, (tptr tuint)) ::
               (_t'33, (tptr (Tstruct _Object noattr))) :: (_t'32, tfloat) ::
               (_t'31, tfloat) ::
               (_t'30, (tptr (Tstruct _Controller noattr))) ::
               (_t'29, tfloat) ::
               (_t'28, (tptr (Tstruct _Controller noattr))) ::
               (_t'27, tfloat) ::
               (_t'26, (tptr (Tstruct _Controller noattr))) ::
               (_t'25, tint) :: (_t'24, tint) :: (_t'23, tint) ::
               (_t'22, tshort) :: (_t'21, tint) :: (_t'20, tfloat) ::
               (_t'19, tuint) :: (_t'18, tfloat) :: (_t'17, tfloat) ::
               (_t'16, (tptr tuint)) ::
               (_t'15, (tptr (Tstruct _Object noattr))) :: (_t'14, tint) ::
               (_t'13, tfloat) ::
               (_t'12, (tptr (Tstruct _Controller noattr))) ::
               (_t'11, tshort) :: (_t'10, tfloat) ::
               (_t'9, (tptr (Tstruct _Controller noattr))) :: nil);
  fn_body :=
(Ssequence
  (Sset _marioObj
    (Efield
      ...
      (Ssequence
        (Sset _t'37
          (Efield
            (Ederef (Etempvar _m (tptr (Tstruct _MarioState noattr)))
              (Tstruct _MarioState noattr)) _input tushort))
        (Sifthenelse (Ebinop Oand (Etempvar _t'37 tushort)
                       (Econst_int (Int.repr 32768) tint) tint)
          (Ssequence
            (Scall None
              (Evar _add_tree_leaf_particles (Tfunction
      ...
      (Ssequence
        (Ssequence
          ...
          (Ssequence
            (Sset _t'29
              (Efield
                (Ederef (Etempvar _t'28 (tptr (Tstruct _Controller noattr)))
                  (Tstruct _Controller noattr)) _stickY tfloat))
            (Sifthenelse (Ebinop Ogt (Etempvar _t'29 tfloat)
                    ...
                    (Sset _t'36
                      (Efield
                        (Ederef
                          ...
                          (Tstruct _Object noattr)) _hitboxHeight tfloat))
                    (Sset _poleTop
                      (Ebinop Osub (Etempvar _t'36 tfloat)
                        (Econst_single (Float32.of_bits (Int.repr 1120403456)) tfloat)
                        tfloat))))
                (Ssequence
                  (Ssequence
                      ...
                      (Ssequence
                        ...
                        (Scall (Some _t'3)
                          ...
                          ((Econst_int (Int.repr 19) tint) ::
                           (Etempvar _t'34 (tptr tuint)) :: nil))))
                    (Sset _poleBehavior (Etempvar _t'3 (tptr tvoid))))
                  (Ssequence
                    (Ssequence
                      (Sset _t'32
                        (Ederef
                          (Ebinop Oadd
                            ...
                            (Econst_int (Int.repr 34) tint) (tptr tfloat))
                          tfloat))
                      (Sifthenelse (Ebinop Olt (Etempvar _t'32 tfloat)
                        ...
                        (Ssequence
                          ...
                          (Ssequence
                            (Sset _t'31
                              (Efield
                                (Ederef
                                  (Etempvar _t'30 (tptr (Tstruct _Controller noattr)))
                                  (Tstruct _Controller noattr)) _stickY
                                tfloat))
                            (Sset _t'6
                              (Ecast
                                (Ebinop Ogt (Etempvar _t'31 tfloat)
                                  (Econst_single (Float32.of_bits (Int.repr 1112014848)) tfloat)
                                  tint) tbool))))
        ...
        (Ssequence
          (Ssequence
            ...
            (Ssequence
              (Sset _t'10
                (Efield
                  (Ederef (Etempvar _t'9 (tptr (Tstruct _Controller noattr)))
                    (Tstruct _Controller noattr)) _stickY tfloat))
                          ...
                          (Ssequence
                            ...
                            (Sassign
                              ...
                              (Ebinop Osub (Etempvar _t'20 tfloat)
                                (Ebinop Odiv (Etempvar _t'21 tint)
                          ...
                          (Ssequence
                            ...
                            (Ssequence
                              ...
                              (Scall None
                                ...
                                ((Econst_int (Int.repr 1) tint) ::
                                 (Ebinop Omul
                                   (Ebinop Odiv (Etempvar _t'14 tint)
                                     (Econst_int (Int.repr 256) tint) tint)
                                   (Econst_int (Int.repr 2) tint) tint) ::
                                 nil)))))))))
                (Ssequence
...
Definition f_act_climbing_pole := {|
  ...
  fn_temps := ((_sp24, tint) ::
               (_marioObj, (tptr (Tstruct _Object noattr))) ::
               (_cameraAngle, tshort) :: (_t'4, tint) :: (_t'3, tint) ::
               (_t'2, tuint) :: (_t'1, tuint) :: (_t'17, tshort) ::
               (_t'16, (tptr (Tstruct _Camera noattr))) ::
               (_t'15, (tptr (Tstruct _Area noattr))) :: (_t'14, tshort) ::
               (_t'13, tushort) :: (_t'12, tfloat) ::
               (_t'11, (tptr (Tstruct _Controller noattr))) ::
               (_t'10, tfloat) ::
               (_t'9, (tptr (Tstruct _Controller noattr))) ::
               (_t'8, tfloat) :: (_t'7, tshort) :: (_t'6, tfloat) ::
               (_t'5, (tptr (Tstruct _Controller noattr))) :: nil);
  fn_body :=
(Ssequence
  (Sset _marioObj
    (Efield
    ...
    (Ssequence
      ...
      (Ssequence
        ...
        (Ssequence
          (Sset _t'17
            (Efield
              (Ederef (Etempvar _t'16 (tptr (Tstruct _Camera noattr)))
                (Tstruct _Camera noattr)) _yaw tshort))
          (Sset _cameraAngle (Ecast (Etempvar _t'17 tshort) tshort)))))
    (Ssequence
      (Ssequence
        (Sset _t'13
          (Efield
      ...
      (Ssequence
        (Ssequence
          ...
          (Ssequence
            (Sset _t'12
              (Efield
                (Ederef (Etempvar _t'11 (tptr (Tstruct _Controller noattr)))
                  (Tstruct _Controller noattr)) _stickY tfloat))
            (Sifthenelse (Ebinop Olt (Etempvar _t'12 tfloat)
                      ...
                      (Ssequence
                        ...
                        (Ssequence
                          ...
                          (Sset _sp24
                            (Ecast
                              (Ebinop Omul
                                (Ebinop Odiv (Etempvar _t'6 tfloat)
