(* ======================================================================
   ...
   Link hygiene:    private __stringlit_N atoms prefixed with us_envfx_snow
   ====================================================================== *)
...
Definition f_envfx_update_snow := {|
  ...
  fn_temps := ((_i, tint) :: (_gfxStart, (tptr (Tunion __549 noattr))) ::
               ...
               (_t'17, (tptr (Tunion __549 noattr))) ::
               (_t'16, (tptr (Tunion __549 noattr))) :: (_t'15, tuint) ::
               (_t'14, (tptr (Tunion __549 noattr))) :: (_t'13, tuint) ::
               (_t'12, (tptr (Tunion __549 noattr))) :: (_t'11, tuint) ::
               (_t'10, (tptr (Tunion __549 noattr))) :: (_t'9, tuint) ::
               (_t'8, (tptr (Tunion __549 noattr))) :: (_t'7, tuint) ::
               ...
               (_t'1, (tptr tvoid)) :: (_t'45, tshort) :: (_t'44, tshort) ::
               (_t'43, tshort) :: (_t'42, tshort) :: (_t'41, tshort) ::
               (_t'40, tshort) :: (_t'39, tshort) :: (_t'38, tshort) ::
               (_t'37, tshort) :: (_t'36, tshort) :: (_t'35, tshort) ::
               (_t'34, tshort) :: (_t'33, tshort) :: (_t'32, tshort) ::
               (_t'31, tshort) :: (_t'30, tshort) :: (_t'29, tshort) ::
               (_t'28, tshort) :: (_t'27, tshort) :: (_t'26, tshort) ::
               (_t'25, tshort) :: (_t'24, tshort) :: (_t'23, tshort) ::
               (_t'22, tshort) :: (_t'21, tshort) :: (_t'20, tshort) ::
               (_t'19, tshort) :: (_t'18, tshort) :: nil);
  fn_body :=
(Ssequence
  ...
  (Ssequence
    ...
    (Ssequence
      ...
      (Ssequence
        (Ssequence
          (Ssequence
            (Sset _t'45 (Evar _gSnowParticleCount tshort))
            (Scall (Some _t'1)
              (Evar _alloc_display_list (Tfunction (tuint :: nil)
                                          (tptr tvoid) cc_default))
              ((Ebinop Omul
                 (Ebinop Oadd
                   (Ebinop Omul (Etempvar _t'45 tshort)
                     (Econst_int (Int.repr 6) tint) tint)
                   (Econst_int (Int.repr 3) tint) tint)
                 (Esizeof (Tunion __549 noattr) tuint) tuint) :: nil)))
          (Sset _gfxStart
            (Ecast (Etempvar _t'1 (tptr tvoid)) (tptr (Tunion __549 noattr)))))
        (Ssequence
                ...
                (Ssequence
                  (Sswitch (Etempvar _snowMode tint)
                    (LScons (Some 1)
                      (Ssequence
                        (Ssequence
                          (Sset _t'43 (Evar _radius tshort))
                          (Sifthenelse (Ebinop Ogt (Etempvar _t'43 tshort)
                                         (Econst_int (Int.repr 250) tint)
                                         tint)
                            (Ssequence
                              (Sset _t'44 (Evar _radius tshort))
                              (Sassign (Evar _radius tshort)
                                (Ebinop Osub (Etempvar _t'44 tshort)
                                  (Econst_int (Int.repr 250) tint) tint)))
                            (Sassign (Evar _radius tshort)
                              (Econst_int (Int.repr 1) tint))))
                        (Ssequence
                          (Ssequence
                            (Sset _t'40 (Evar _radius tshort))
                            (Ssequence
                              (Sset _t'41 (Evar _pitch tshort))
                              (Ssequence
                                (Sset _t'42 (Evar _yaw tshort))
                                (Scall None
                                ...
                                (Ssequence
                                  ...
                                  (Scall None
                                    ...
                                    ((Etempvar _t'37 tshort) ::
                                     ...
                                     (Etempvar _t'39 tshort) :: nil)))))
                            Sbreak)))
                      (LScons (Some 2)
                        (Ssequence
                          (Ssequence
                            (Sset _t'35 (Evar _radius tshort))
                            (Sifthenelse (Ebinop Ogt (Etempvar _t'35 tshort)
                                           (Econst_int (Int.repr 500) tint)
                                           tint)
                              (Ssequence
                                (Sset _t'36 (Evar _radius tshort))
                                (Sassign (Evar _radius tshort)
                                  (Ebinop Osub (Etempvar _t'36 tshort)
                                    (Econst_int (Int.repr 500) tint) tint)))
                              (Sassign (Evar _radius tshort)
                                (Econst_int (Int.repr 1) tint))))
                          (Ssequence
                            (Ssequence
                              (Sset _t'32 (Evar _radius tshort))
                              (Ssequence
                                (Sset _t'33 (Evar _pitch tshort))
                                (Ssequence
                                  (Sset _t'34 (Evar _yaw tshort))
                                  (Scall None
                                    (Evar _pos_from_orbit (Tfunction
                                                            ((tptr tshort) ::
                                                             (tptr tshort) ::
                          ...
                          (Ssequence
                            (Ssequence
                              ...
                              (Sifthenelse (Ebinop Ogt
                                             ...
                                             tint)
                                (Ssequence
                                  (Sset _t'28 (Evar _radius tshort))
                                  (Sassign (Evar _radius tshort)
                            ...
                            (Ssequence
                              (Ssequence
                                (Sset _t'24 (Evar _radius tshort))
                                (Ssequence
                                  (Sset _t'25 (Evar _pitch tshort))
                                  (Ssequence
                                    (Sset _t'26 (Evar _yaw tshort))
                                    (Scall None
                                      (Evar _pos_from_orbit (Tfunction
                                                              ((tptr tshort) ::
                                                               (tptr tshort) ::
                                    ...
                                    (Ssequence
                                      ...
                                      (Scall None
                                        ...
                                        ((Etempvar _t'21 tshort) ::
                                         ...
                                         (Etempvar _t'23 tshort) :: nil)))))
                                Sbreak)))
                          LSnil))))
                  (Ssequence
                    (Ssequence
                      (Sset _t'19 (Evar _pitch tshort))
                      (Ssequence
                        (Sset _t'20 (Evar _yaw tshort))
                        (Scall None
                          ...
                          ((Ecast
                           ...
                           (Ecast
                             (Eaddrof
                               ...
                               (tptr (Tstruct _SnowFlakeVertex noattr)))
                             (tptr tshort)) :: (Etempvar _t'19 tshort) ::
                            ...
                            (Ssequence
                              (Ssequence
                                (Ssequence
                                  ...
                                  (Sset _gfx
                                    (Ebinop Oadd
                                      (Etempvar _t'17 (tptr (Tunion __549 noattr)))
                                      (Econst_int (Int.repr 1) tint)
                                      (tptr (Tunion __549 noattr)))))
                                (Sset __g__8
                                  (Ecast
...
Definition f_envfx_update_particles := {|
  ...
  fn_temps := ((_gfx, (tptr (Tunion __549 noattr))) ::
               ...
               (_t'6, (tptr (Tunion __549 noattr))) :: (_t'5, tint) ::
               (_t'4, tint) :: (_t'3, (tptr (Tunion __549 noattr))) ::
              ...
              (LScons (Some 1)
                (Ssequence
                  (Ssequence
                    ...
                    (Sset _gfx (Etempvar _t'6 (tptr (Tunion __549 noattr)))))
                  Sbreak)
                (LScons (Some 2)
                  (Ssequence
                    (Ssequence
