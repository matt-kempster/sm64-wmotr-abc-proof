(* ======================================================================
   ...
   Source:          src/game/mario_actions_moving.c
   ...
   Link hygiene:    private __stringlit_N atoms prefixed with jp_mario_actions_moving
   ====================================================================== *)
...
Module Info.
  ...
  Definition source_file := "build/pinned-sm64/src/game/mario_actions_moving.c".
      ...
      (Ssequence
        (Sset _t'21
          (Efield
            (Efield
              (Ederef (Etempvar _floor (tptr (Tstruct _Surface noattr)))
                (Tstruct _Surface noattr)) _normal (Tstruct __732 noattr)) _x
            tfloat))
        (Ssequence
          (Sset _t'22
            (Efield
               ...
               (Ebinop Oor
                 (Ebinop Oor
                   ...
                   (Ebinop Oshl (Ecast (Econst_int (Int.repr 0) tint) tuint)
                     (Econst_int (Int.repr 8) tint) tuint) tuint)
                 (Econst_int (Int.repr 67108864) tint) tuint)
               (Econst_int (Int.repr 1) tint) tuint) (Etempvar _t'28 tuint)
             tuint) ::
           (Efield
             (Efield
               (Efield
                      ...
                      (Ssequence
                        ...
                        (Sset _t'2
                          (Ecast
                            (Ebinop Olt
                              (Econst_single (Float32.of_bits (Int.repr 1112014848)) tfloat)
                              (Etempvar _t'27 tfloat) tint) tbool)))))
                  (Sifthenelse (Etempvar _t'2 tint)
                    (Ssequence
                      (Sset _t'25
                        (Efield
                          ...
                          (Sassign
                            (Efield
                              (Ederef
                                ...
                                (Tstruct _MarioState noattr)) _particleFlags
                              tuint)
                            (Ebinop Oor (Etempvar _t'23 tuint)
                              (Ebinop Oshl (Econst_int (Int.repr 1) tint)
                                (Econst_int (Int.repr 1) tint) tint) tuint)))
                        (Scall None
                          (Evar _slide_bonk (Tfunction
    ...
    (Ssequence
      ...
      (Scall (Some _t'1)
        ...
        ((Etempvar _m (tptr (Tstruct _MarioState noattr))) ::
         ...
         (Econst_int (Int.repr 1) tint) :: (Etempvar _t'4 tuint) :: nil)))
