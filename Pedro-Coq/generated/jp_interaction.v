(* ======================================================================
   ...
   Link hygiene:    private __stringlit_N atoms prefixed with jp_interaction
   ====================================================================== *)
...
Module Info.
  ...
  Definition source_file := "build/pinned-sm64/src/game/interaction.c".
...
Definition v_sInteractionHandlers := {|
  ...
  gvar_init := (Init_int32 (Int.repr 16) ::
...
Definition f_interact_hit_from_below := {|
  ...
  fn_temps := ((_interaction, tuint) :: (_t'3, tuint) :: (_t'2, tint) ::
               (_t'1, tuint) :: (_t'6, tuint) :: (_t'5, tuint) ::
               (_t'4, tuint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
  ...
  (Ssequence
      ...
      (Sifthenelse (Etempvar _t'3 tint)
        (Ssequence
          (Scall (Some _t'6)
            ...
            ((Etempvar _m (tptr (Tstruct _MarioState noattr))) ::
             (Etempvar _o (tptr (Tstruct _Object noattr))) ::
             (Econst_int (Int.repr 14563) tint) :: nil))
    ...
    (Sifthenelse (Etempvar _t'5 tint)
      (Ssequence
        ...
        (Ssequence
          (Sifthenelse (Ebinop Oge (Etempvar _facingDYaw tshort)
                         (Eunop Oneg (Econst_int (Int.repr 14563) tint) tint)
                         tint)
            (Sset _t'2
              (Ecast
                (Ebinop Ole (Etempvar _facingDYaw tshort)
                  (Econst_int (Int.repr 14563) tint) tint) tbool))
            (Sset _t'2 (Econst_int (Int.repr 0) tint)))
          (Sifthenelse (Etempvar _t'2 tint)
            (Ssequence
              (Ssequence
            ...
            (Sloop
              (Ssequence
                (Sifthenelse (Ebinop Olt (Etempvar _i tint)
                               (Ecast
                                 (Ebinop Odiv
                                   (Esizeof (tarray (Tstruct _InteractionHandler noattr) 31) tuint)
                                   (Esizeof (Tstruct _InteractionHandler noattr) tuint)
                                   tuint) tint) tint)
                  Sskip
                  Sbreak)
                (Ssequence
