(* ======================================================================
   ...
   Link hygiene:    private __stringlit_N atoms prefixed with jp_mario
   ====================================================================== *)
...
Module Info.
  ...
  Definition source_file := "build/pinned-sm64/src/game/mario.c".
...
Definition ___stringlit_1 : ident := $"__jp_mario_stringlit_1".
Definition ___stringlit_2 : ident := $"__jp_mario_stringlit_2".
Definition ___stringlit_3 : ident := $"__jp_mario_stringlit_3".
        ...
        (Ssequence
          ...
          (Scall None
            ...
            ((Ebinop Oadd
               ...
               (Ebinop Oshl
                 (Ebinop Omod (Etempvar _t'3 tuint)
          ...
          (Efield
            (Efield
              (Ederef (Etempvar _t'3 (tptr (Tstruct _Surface noattr)))
                (Tstruct _Surface noattr)) _normal (Tstruct __732 noattr)) _y
            tfloat))
            ...
            (Efield
              (Efield
                (Ederef (Etempvar _t'6 (tptr (Tstruct _Surface noattr)))
                  (Tstruct _Surface noattr)) _normal (Tstruct __732 noattr))
              _y tfloat)))
        (Ssequence
          (Ssequence
            (Scall (Some _t'2)
            ...
            (Ssequence
              ...
              (Scall None
                ...
                ((Econst_int (Int.repr 210) tint) ::
                 ...
                 (Evar ___stringlit_2 (tarray tuchar 7)) ::
            ...
            (Ssequence
              ...
              (Scall None
                ...
                ((Econst_int (Int.repr 210) tint) ::
                 ...
                 (Evar ___stringlit_3 (tarray tuchar 7)) ::
...
Definition f_execute_mario_action := {|
  ...
  fn_temps := ((_inLoop, tint) :: (_t'7, tint) :: (_t'6, tint) ::
               ...
               (_t'2, tint) :: (_t'1, tint) :: (_t'48, tshort) ::
               (_t'47, (tptr (Tstruct _Object noattr))) ::
               (_t'46, (tptr (Tstruct _MarioState noattr))) ::
               (_t'45, (tptr (Tstruct _Object noattr))) ::
                        ...
                        (Efield
                          (Efield
                            (Efield
                              ...
                              (Tstruct _GraphNodeObject noattr)) _node
                            (Tstruct _GraphNode noattr)) _flags tshort)
                        (Ebinop Oand (Etempvar _t'48 tshort)
                          (Eunop Onotint
                            (Ebinop Oshl (Econst_int (Int.repr 1) tint)
                              (Econst_int (Int.repr 4) tint) tint) tint)
                          tint)))))))
                            ...
                            (Ssequence
                              (Sset _t'30
                                (Efield
                                  ...
                                  tuint))
                              (Sswitch (Ebinop Oand (Etempvar _t'30 tuint)
