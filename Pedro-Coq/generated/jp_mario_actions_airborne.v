(* ======================================================================
   ...
   Source:          src/game/mario_actions_airborne.c
   ...
   Link hygiene:    private __stringlit_N atoms prefixed with jp_mario_actions_airborne
   ====================================================================== *)
...
Module Info.
  ...
  Definition source_file := "build/pinned-sm64/src/game/mario_actions_airborne.c".
          ...
          (Efield
            (Efield
              (Ederef (Etempvar _t'9 (tptr (Tstruct _Surface noattr)))
                (Tstruct _Surface noattr)) _normal (Tstruct __732 noattr)) _z
            tfloat))
        (Ssequence
          (Sset _t'11
            (Efield
...
Definition f_check_horizontal_wind := {|
  ...
  fn_temps := ((_floor, (tptr (Tstruct _Surface noattr))) ::
               ...
               (_t'1, tfloat) :: (_t'22, tshort) :: (_t'21, tfloat) ::
      ...
      (Sifthenelse (Ebinop Oeq (Etempvar _t'3 tshort)
        ...
        (Ssequence
          (Ssequence
            ...
            (Sset _pushAngle
              (Ecast
                (Ebinop Oshl (Etempvar _t'22 tshort)
                ...
                (Sassign
                  ...
                  (Ebinop Oadd (Etempvar _t'20 tfloat)
                    (Ebinop Omul
                      ...
                      (Etempvar _t'21 tfloat) tfloat) tfloat))))
            (Ssequence
              (Ssequence
                (Sset _t'18
                  (Efield
...
Definition f_act_flying := {|
  ...
  fn_temps := ((_startPitch, tshort) :: (_t'9, tint) :: (_t'8, tint) ::
               ...
               (_t'1, tuint) :: (_t'73, tshort) :: (_t'72, tuchar) ::
               (_t'71, (tptr (Tstruct _Camera noattr))) ::
               (_t'70, (tptr (Tstruct _Area noattr))) ::
               (_t'69, (tptr (Tstruct _Camera noattr))) ::
               (_t'68, (tptr (Tstruct _Area noattr))) :: (_t'67, tuchar) ::
               (_t'66, (tptr (Tstruct _Camera noattr))) ::
               (_t'65, (tptr (Tstruct _Area noattr))) :: (_t'64, tushort) ::
               (_t'63, tuchar) :: (_t'62, (tptr (Tstruct _Camera noattr))) ::
               (_t'61, (tptr (Tstruct _Area noattr))) ::
               (_t'60, (tptr (Tstruct _Camera noattr))) ::
               (_t'59, (tptr (Tstruct _Area noattr))) :: (_t'58, tuchar) ::
               (_t'57, (tptr (Tstruct _Camera noattr))) ::
               (_t'56, (tptr (Tstruct _Area noattr))) :: (_t'55, tuint) ::
               (_t'54, (tptr (Tstruct _Camera noattr))) ::
               (_t'53, (tptr (Tstruct _Area noattr))) :: (_t'52, tuchar) ::
               (_t'51, (tptr (Tstruct _Camera noattr))) ::
               (_t'50, (tptr (Tstruct _Area noattr))) ::
               (_t'49, (tptr (Tstruct _Object noattr))) :: (_t'48, tshort) ::
               (_t'47, (tptr (Tstruct _Object noattr))) :: (_t'46, tuint) ::
               (_t'45, tuint) :: (_t'44, tushort) :: (_t'43, tshort) ::
               (_t'42, (tptr (Tstruct _Object noattr))) :: (_t'41, tshort) ::
               (_t'40, (tptr (Tstruct _Object noattr))) :: (_t'39, tuchar) ::
               (_t'38, (tptr (Tstruct _Camera noattr))) ::
               (_t'37, (tptr (Tstruct _Area noattr))) ::
               (_t'36, (tptr (Tstruct _Camera noattr))) ::
               (_t'35, (tptr (Tstruct _Area noattr))) :: (_t'34, tfloat) ::
               (_t'33, tuint) :: (_t'32, (tptr (Tstruct _Object noattr))) ::
               (_t'31, tuint) :: (_t'30, tuchar) ::
               (_t'29, (tptr (Tstruct _Camera noattr))) ::
               (_t'28, (tptr (Tstruct _Area noattr))) ::
               (_t'27, (tptr (Tstruct _Camera noattr))) ::
               (_t'26, (tptr (Tstruct _Area noattr))) ::
               (_t'25, (tptr (Tstruct _Object noattr))) ::
               (_t'24, tushort) :: (_t'23, tshort) :: (_t'22, tshort) ::
               (_t'21, tshort) :: (_t'20, (tptr (Tstruct _Object noattr))) ::
               (_t'19, tshort) :: (_t'18, (tptr (Tstruct _Object noattr))) ::
               (_t'17, (tptr (Tstruct _Surface noattr))) ::
               (_t'16, tfloat) :: (_t'15, tshort) :: (_t'14, tuint) ::
               (_t'13, tshort) :: (_t'12, tfloat) ::
        ...
        (Ebinop Oadd
          (Efield
            (Ederef (Etempvar _m (tptr (Tstruct _MarioState noattr)))
              (Tstruct _MarioState noattr)) _faceAngle (tarray tshort 3))
          (Econst_int (Int.repr 0) tint) (tptr tshort)) tshort))
    (Sset _startPitch (Ecast (Etempvar _t'73 tshort) tshort)))
  (Ssequence
    (Ssequence
      (Sset _t'64
        (Efield
          (Ederef (Etempvar _m (tptr (Tstruct _MarioState noattr)))
            (Tstruct _MarioState noattr)) _input tushort))
      (Sifthenelse (Ebinop Oand (Etempvar _t'64 tushort)
                     (Econst_int (Int.repr 32768) tint) tint)
        (Ssequence
          (Ssequence
            (Sset _t'65
            ...
            (Ssequence
              (Sset _t'66
                (Efield
                  (Ederef (Etempvar _t'65 (tptr (Tstruct _Area noattr)))
                    (Tstruct _Area noattr)) _camera
                  (tptr (Tstruct _Camera noattr))))
              (Ssequence
                (Sset _t'67
                  (Efield
                    (Ederef (Etempvar _t'66 (tptr (Tstruct _Camera noattr)))
                      (Tstruct _Camera noattr)) _mode tuchar))
                (Sifthenelse (Ebinop Oeq (Etempvar _t'67 tuchar)
                               (Econst_int (Int.repr 3) tint) tint)
                  (Ssequence
                    (Sset _t'68
                      (Efield
                    ...
                    (Ssequence
                      (Sset _t'69
                        (Efield
                          (Ederef
                            (Etempvar _t'68 (tptr (Tstruct _Area noattr)))
                            (Tstruct _Area noattr)) _camera
                          (tptr (Tstruct _Camera noattr))))
                      (Ssequence
                        (Sset _t'70
                            ...
                            (Scall None
                              (Evar _set_camera_mode (Tfunction
                                                       ((tptr (Tstruct _Camera noattr)) ::
                                                        ...
                                                        nil) tvoid
                                                       cc_default))
                              ((Etempvar _t'69 (tptr (Tstruct _Camera noattr))) ::
        ...
        (Sset _t'55
          (Efield
            (Ederef (Etempvar _m (tptr (Tstruct _MarioState noattr)))
              (Tstruct _MarioState noattr)) _flags tuint))
        (Sifthenelse (Eunop Onotbool
                       (Ebinop Oand (Etempvar _t'55 tuint)
          ...
          (Ssequence
            (Ssequence
              ...
              (Ssequence
                (Sset _t'57
                  (Efield
                    (Ederef (Etempvar _t'56 (tptr (Tstruct _Area noattr)))
                      (Tstruct _Area noattr)) _camera
                    (tptr (Tstruct _Camera noattr))))
                (Ssequence
                  (Sset _t'58
                    (Efield
                      (Ederef
                        (Etempvar _t'57 (tptr (Tstruct _Camera noattr)))
                        (Tstruct _Camera noattr)) _mode tuchar))
                  (Sifthenelse (Ebinop Oeq (Etempvar _t'58 tuchar)
                                 (Econst_int (Int.repr 3) tint) tint)
                    (Ssequence
                      (Sset _t'59
                        (Efield
                      ...
                      (Ssequence
                        (Sset _t'60
                          (Efield
                            (Ederef
                              (Etempvar _t'59 (tptr (Tstruct _Area noattr)))
                              (Tstruct _Area noattr)) _camera
                            (tptr (Tstruct _Camera noattr))))
                        (Ssequence
                          (Sset _t'61
                              ...
                              (Scall None
                                (Evar _set_camera_mode (Tfunction
                                                         ((tptr (Tstruct _Camera noattr)) ::
                                                          ...
                                                          nil) tvoid
                                                         cc_default))
                                ((Etempvar _t'60 (tptr (Tstruct _Camera noattr))) ::
      ...
      (Ssequence
        (Ssequence
          ...
          (Ssequence
            (Sset _t'51
              (Efield
                (Ederef (Etempvar _t'50 (tptr (Tstruct _Area noattr)))
                  (Tstruct _Area noattr)) _camera
                (tptr (Tstruct _Camera noattr))))
            (Ssequence
              (Sset _t'52
                (Efield
                  (Ederef (Etempvar _t'51 (tptr (Tstruct _Camera noattr)))
                    (Tstruct _Camera noattr)) _mode tuchar))
              (Sifthenelse (Ebinop One (Etempvar _t'52 tuchar)
                             (Econst_int (Int.repr 3) tint) tint)
                (Ssequence
                  (Sset _t'53
                    (Efield
                  ...
                  (Ssequence
                    (Sset _t'54
                      (Efield
                        (Ederef
                          (Etempvar _t'53 (tptr (Tstruct _Area noattr)))
                          (Tstruct _Area noattr)) _camera
                        (tptr (Tstruct _Camera noattr))))
                    (Scall None
                      (Evar _set_camera_mode (Tfunction
                                               ((tptr (Tstruct _Camera noattr)) ::
                                                tshort :: tshort :: nil)
                                               tvoid cc_default))
                      ((Etempvar _t'54 (tptr (Tstruct _Camera noattr))) ::
                       (Econst_int (Int.repr 3) tint) ::
                       (Econst_int (Int.repr 1) tint) :: nil))))
                Sskip))))
        (Ssequence
          (Ssequence
            (Sset _t'44
              (Efield
                (Ederef (Etempvar _m (tptr (Tstruct _MarioState noattr)))
                  (Tstruct _MarioState noattr)) _actionState tushort))
            (Sifthenelse (Ebinop Oeq (Etempvar _t'44 tushort)
                           (Econst_int (Int.repr 0) tint) tint)
              (Ssequence
                (Ssequence
                  (Sset _t'46
                          ...
                          (Sset _t'48
                            (Efield
                              (Efield
                                ...
                                _animInfo (Tstruct _AnimInfo noattr))
                              _animFrame tshort))
                          (Sifthenelse (Ebinop Oeq (Etempvar _t'48 tshort)
                                         (Econst_int (Int.repr 1) tint) tint)
                            (Ssequence
                              (Sset _t'49
                                (Efield
                          ...
                          (Sassign
                            (Ederef
                              (Ebinop Oadd
                                ...
                                (Econst_int (Int.repr 0) tint) (tptr tshort))
                              tshort)
                            (Eunop Oneg (Etempvar _t'43 tshort) tint))))
                      (Ssequence
                        (Ssequence
                          (Sset _t'40
                            (Efield
                                ...
                                (Ssequence
                                  ...
                                  (Ssequence
                                    (Sset _t'36
                                      (Efield
                                        (Ederef
                                          (Etempvar _t'35 (tptr (Tstruct _Area noattr)))
                                          (Tstruct _Area noattr)) _camera
                                        (tptr (Tstruct _Camera noattr))))
                                    (Ssequence
                                      (Sset _t'37
                                        ...
                                        (Ssequence
                                          ...
                                          (Scall None
                                            (Evar _set_camera_mode (Tfunction
                                                                    ...
                                                                    tvoid
                                                                    cc_default))
                                            ((Etempvar _t'36 (tptr (Tstruct _Camera noattr))) ::
                                          ...
                                          (Ssequence
                                            ...
                                            (Ssequence
                                              (Sset _t'27
                                                (Efield
                                                  (Ederef
                                                    (Etempvar _t'26 (tptr (Tstruct _Area noattr)))
                                                    ...
                                                    (Scall None
                                                      ...
                                                      (Tfunction
                                                        ((tptr (Tstruct _Camera noattr)) ::
                                                         ...
                                                         nil) tvoid
                                                        cc_default))
                                                      ((Etempvar _t'27 (tptr (Tstruct _Camera noattr))) ::
                    ...
                    (Ssequence
                      (Sifthenelse (Ebinop Ole (Etempvar _startPitch tshort)
                        ...
                        (Ssequence
                          ...
                          (Sset _t'8
                            (Ecast
                              (Ebinop Ogt (Etempvar _t'13 tshort)
                                (Econst_int (Int.repr 0) tint) tint) tbool)))
...
Definition f_act_flying_triple_jump := {|
  ...
  fn_temps := ((_t'8, tint) :: (_t'7, tint) :: (_t'6, tint) ::
               ...
               (_t'2, tuint) :: (_t'1, tuint) :: (_t'30, tushort) ::
               (_t'29, tushort) ::
...
(_mario_execute_airborne_action :: _check_common_airborne_cancels ::
 ...
 _check_fall_damage :: _lava_boost_on_wall :: _play_far_fall_sound ::
 _play_flip_sounds :: _gSpecialTripleJump :: _perform_air_step ::
 _mario_bonk_reflection :: _set_water_plunge_action ::
 ...
 _play_sound :: _set_camera_mode :: _set_camera_shake_from_hit :: _sqrtf ::
