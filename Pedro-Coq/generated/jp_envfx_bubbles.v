(* ======================================================================
   ...
   Link hygiene:    private __stringlit_N atoms prefixed with jp_envfx_bubbles
   ====================================================================== *)
...
Definition v_tiny_bubble_dl_0B006AB0 := {|
  gvar_info := (tarray (Tunion __512 noattr) 0);
  gvar_init := nil;
  gvar_readonly := true;
  gvar_volatile := false
|}.
  ...
  (Ssequence
    ...
    (Ssequence
      (Ssequence
        (Ssequence
          (Ssequence
            (Sset _t'4 (Evar _sGfxCursor (tptr (Tunion __512 noattr))))
            (Sassign (Evar _sGfxCursor (tptr (Tunion __512 noattr)))
      ...
      (Ssequence
        (Ssequence
          (Ssequence
            (Sset _t'5 (Evar _sGfxCursor (tptr (Tunion __512 noattr))))
            (Sassign (Evar _sGfxCursor (tptr (Tunion __512 noattr)))
        ...
        (Ssequence
          ...
          (Sassign
            ...
            (Ecast
              (Eaddrof
                (Evar _tiny_bubble_dl_0B006D68 (tarray (Tunion __512 noattr) 0))
                (tptr (tarray (Tunion __512 noattr) 0))) tuint)))))))
|}.
...
Definition f_envfx_update_bubble_particles := {|
  ...
  fn_temps := ((_i, tint) :: (_gfxStart, (tptr (Tunion __512 noattr))) ::
               ...
               (_t'1, (tptr tvoid)) :: (_t'16, tint) :: (_t'15, tint) ::
               (_t'14, tshort) :: (_t'13, tshort) :: (_t'12, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Ssequence
      (Sset _t'15 (Evar _sBubbleParticleMaxCount tint))
      (Ssequence
        (Sset _t'16 (Evar _sBubbleParticleMaxCount tint))
        (Scall (Some _t'1)
          (Evar _alloc_display_list (Tfunction (tuint :: nil) (tptr tvoid)
                                      cc_default))
          ((Ebinop Omul
             (Ebinop Oadd
               (Ebinop Oadd
                 (Ebinop Omul
                   ...
                   (Econst_int (Int.repr 10) tint) tint)
                 (Etempvar _t'16 tint) tint) (Econst_int (Int.repr 3) tint)
               tint) (Esizeof (Tunion __512 noattr) tuint) tuint) :: nil))))
    ...
    (Ssequence
      ...
      (Ssequence
        ...
        (Ssequence
          ...
          (Ssequence
            (Ssequence
              (Sset _t'13 (Evar _pitch tshort))
              (Ssequence
                (Sset _t'14 (Evar _yaw tshort))
                (Scall None
                  ...
                  ((Evar _vertex1 (tarray tshort 3)) ::
                   ...
                   (Etempvar _t'13 tshort) :: (Etempvar _t'14 tshort) :: nil))))
            (Ssequence
              (Ssequence
                (Ssequence
                  (Ssequence
                    (Sset _t'2
                      (Evar _sGfxCursor (tptr (Tunion __512 noattr))))
                    (Sassign (Evar _sGfxCursor (tptr (Tunion __512 noattr)))
                      (Ebinop Oadd
                ...
                (Ssequence
                  ...
                  (Sassign
                    ...
                    (Ecast
                      (Eaddrof
                        (Evar _tiny_bubble_dl_0B006D38 (tarray (Tunion __512 noattr) 0))
                        (tptr (tarray (Tunion __512 noattr) 0))) tuint))))
              (Ssequence
                (Ssequence
                  (Sset _i (Econst_int (Int.repr 0) tint))
                  (Sloop
                    (Ssequence
                      (Ssequence
                        (Sset _t'12 (Evar _sBubbleParticleMaxCount tint))
                        (Sifthenelse (Ebinop Olt (Etempvar _i tint)
                      ...
                      (Ssequence
                        ...
                        (Sassign
                          ...
                          (Ebinop Oadd
                            ...
                            (tptr (Tunion __512 noattr)))))
                      (Sset __g__7
                        (Ecast (Etempvar _t'10 (tptr (Tunion __512 noattr)))
                          (tptr (Tunion __512 noattr)))))
                    (Ssequence
                      (Sassign
                        (Efield
                        ...
                        (Ebinop Oor
                          (Ebinop Oor
                            (Ecast
                              (Ebinop Oshl
                                (Ebinop Oand
                                  (Ecast (Econst_int (Int.repr 6) tint)
                                    tuint)
                                  (Ebinop Osub
                                    (Ebinop Oshl
                                      (Econst_int (Int.repr 1) tint)
                      ...
                      (Sassign
                        ...
                        (Ecast
                          (Eaddrof
                            (Evar _tiny_bubble_dl_0B006AB0 (tarray (Tunion __512 noattr) 0))
                            (tptr (tarray (Tunion __512 noattr) 0))) tuint))))
                  (Ssequence
                    (Ssequence
                      (Ssequence
...
Definition f_envfx_update_bubbles := {|
  ...
  fn_temps := ((_gfx, (tptr (Tunion __512 noattr))) ::
               ...
               (_t'5, (tptr (Tunion __512 noattr))) ::
               (_t'4, (tptr (Tunion __512 noattr))) ::
               (_t'3, (tptr (Tunion __512 noattr))) :: (_t'2, tint) ::
                ...
                (Ssequence
                  (Scall (Some _t'4)
                    ...
                    ((Econst_int (Int.repr 12) tint) ::
                     ...
                     (Etempvar _camFrom (tptr tshort)) ::
                     (Etempvar _camTo (tptr tshort)) :: nil))
                  (Sset _gfx (Etempvar _t'4 (tptr (Tunion __512 noattr)))))
                Sbreak)
              (LScons (Some 13)
                (Ssequence
                  (Ssequence
                    (Scall (Some _t'5)
                      ...
                      ((Econst_int (Int.repr 13) tint) ::
                       ...
                       (Etempvar _camFrom (tptr tshort)) ::
                       (Etempvar _camTo (tptr tshort)) :: nil))
                    (Sset _gfx (Etempvar _t'5 (tptr (Tunion __512 noattr)))))
                  Sbreak)
                (LScons (Some 14)
                  (Ssequence
                    (Ssequence
