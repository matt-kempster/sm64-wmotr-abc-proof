(* ======================================================================
   ...
   Link hygiene:    private __stringlit_N atoms prefixed with us_level_geo
   ====================================================================== *)
...
Definition f_geo_envfx_main := {|
  ...
  fn_temps := ((_particleList, (tptr tvoid)) ::
               ...
               (__g__1, (tptr (Tunion __549 noattr))) :: (_t'4, tint) ::
          ...
          (Ssequence
            ...
            (Ssequence
              ...
              (Ssequence
                ...
                (Sset _gfx (Etempvar _t'1 (tptr (Tunion __549 noattr)))))))
          Sskip))
      (Sreturn (Some (Etempvar _gfx (tptr (Tunion __549 noattr))))))))
|}.
 ...
 (_create_skybox_facing_camera,
   Gfun(External (EF_external "create_skybox_facing_camera"
     ...
     (tschar :: tschar :: tfloat :: tfloat :: tfloat :: tfloat :: tfloat ::
      tfloat :: tfloat :: nil) (tptr (Tunion __549 noattr)) cc_default)) ::
 (_vec3s_copy,
