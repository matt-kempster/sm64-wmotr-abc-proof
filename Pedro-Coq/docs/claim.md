...
## What the first capstones prove
...
- Dust spawning actually reaches both white-puff initializers under the
  concrete object-list schedule and object-pool conditions.
