(* Integration point between the provenance model and the generated-code
   ...
   obvious generated load/reinit bodies do not mention the stale Mario object
   reference fields before init_mario clears them.  This file packages the
   combination as a single corollary so the checklist can stop treating those
   as two loose facts.
 *)
