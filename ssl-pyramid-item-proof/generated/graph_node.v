(* ======================================================================
   ...
   From source: ../reference-sm64-decomp/src/engine/graph_node.c
...
Module Info.
  ...
  Definition source_file := "../reference-sm64-decomp/src/engine/graph_node.c".
                ...
                (Sassign
                  (Efield
                    (Efield
                      ...
                      (Tunion __1378 noattr)) _mode tint)
                  (Etempvar _mode tint))
                (Ssequence
                  (Sassign
                    (Efield
